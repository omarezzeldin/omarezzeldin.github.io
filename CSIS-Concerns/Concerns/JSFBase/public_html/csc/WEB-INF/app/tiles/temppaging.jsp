...
<t:panelGroup forceId="true" id="paging_panel">
    <t:panelGroup forceId="true" id="paging_panel_group" rendered="#{ (OperationBar.recordsCount > 0) ? true : false }">
       ...
       <t:panelGrid align="center" id="panelGrd_scroller" columns="1" dir="#{shared_util.pageDirection}" styleClass="scroller"  rendered="#{pageBeanName.listSize > shared_util.noOfTableRows}" >
