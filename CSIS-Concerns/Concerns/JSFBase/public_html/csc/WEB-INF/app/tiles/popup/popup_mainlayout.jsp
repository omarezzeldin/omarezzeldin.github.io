...
.divFooter {
  background: #3b71ae none repeat scroll 0 0;
...
.divUserInfo {
    background: rgba(0, 0, 0, 0) url("../../images/top_bar_new2.png") no-repeat scroll left top;
    display: block;
    float: left;
    height: 41px;
    margin-left: 5px;
...
.divheader {
  background: rgba(0, 0, 0, 0) url("../../images/header-bg-small.png") repeat scroll 0 0;
  display: block;
  float: right;
  height: 64px;
  margin-top: -18px;
        ...
        <htm:tr id="div_msg">
            ...
            <htm:tr id="container_of_all_div_tr">
                ...
                <htm:td width="100%" height="100%" valign="top">
                    <htm:div styleClass="divBodyContentInner">
                     <t:div id="popupHeader" styleClass="headtbl" >
           ...
           %>
                                ...
                                <htm:td align="center">
                                    <t:div forceId="true"
                                        ...
                                        <div class="popup_header">
                                            ...
                                            <htm:span rendered="#{pageBeanName.customDiv1TitleKey!=null}">
                                                 <t:panelGrid id="treedivTitleKey" forceId="true">
                                                        <t:outputText value="#{resourcesBundle[title]}"
                                                                      rendered="#{pageBeanName.treeDivTitleKey==null}"/>
                                                        <t:outputText value="#{resourcesBundle[pageBeanName.treeDivTitleKey]}"
                                                                      rendered="#{pageBeanName.treeDivTitleKey!=null}"/>
                                                    </t:panelGrid>
                                            </htm:span>
                                        </div>
            ...
            <%
                           ...
                           <%-- Start showCustomDiv1--%>
                            ...
                            <htm:tr>
                        <htm:td valign="bottom" height="22">
                              <htm:table border="0" width="100%" id="table1" cellspacing="0" cellpadding="0" height="22" >
                                <htm:tr><htm:td><tiles:insert attribute="footer"/></htm:td></htm:tr>
                              </htm:table>
                        </htm:td>
                    </htm:tr>
                        </htm:table>
