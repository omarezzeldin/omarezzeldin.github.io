...
<t:panelGrid columns="4" cellpadding="3" cellspacing="0" rowClasses="row02,row01" width="100%">
    ...
    <t:panelGroup colspan="3">
        ...
        <c:requiredFieldValidator componentToValidate="doctypeMenu" display="dynamic" active="#{!addDocAttachmentsIntegrationBean.disableSelectedDocType}"
    ...
    <t:panelGroup colspan="3" id="attachmentPanel" forceId="true"
        ...
        <t:inputFileUpload id="myInputFileUpload" styleClass="fileUploadComponent"
                           ...
                           value="#{addDocAttachmentsIntegrationBean.uploadedFile}"/>
    ...
    <fieldset id="financialYear">
        ...
        <t:panelGroup>
            ...
            <t:inputCalendar title="#{globalResources.inputCalendarHelpText}"  onblur="return validateInputCalenderFormate('f_start_from','null','null');"
        ...
        <t:panelGroup>
            <t:inputCalendar id="f_end_date" maxlength="10" value="#{pageBeanName.untilDate}"  onblur="return validateInputCalenderFormate('f_end_date','null','null');"
