...
public class AppMainLayout implements Serializable {

	@SuppressWarnings("compatibility:-4485906751177687898")
	private static final long serialVersionUID = 1L;

    private boolean showNavigationPath;
    ...
    private boolean showCustomDiv3;
    private boolean showIntegrationDiv1;
    private boolean showIntegrationDiv2;
    private boolean showScirptGenerator;
    private boolean showLovDiv;
    private boolean showSearchTreeDiv;
    private boolean showEmpSrchDiv;
    private boolean ShowEmpSrchDivPaging; // for emp lov div paging
    private boolean showshortCut;
    private boolean showWizardBar;
    private boolean showPagedTreediv;
    private boolean showTwoVerticalCnt;//tree, list

    // added to show title page or not 
    private boolean showTitlePage;
    private boolean showLookupAddDivBorder;
    private boolean showLookupEditDivBorder;
    
    private boolean conditionActivationIntgDiv;
    
    private boolean showRetroactiveSettDetailsDiv;
    ...
    public AppMainLayout() {
        ...
        setShowCustomDiv2(false);
        setShowCustomDiv3(false);
        setShowScirptGenerator(false);
        setShowLovDiv(false);
        setShowSearchTreeDiv(false);
        setShowTitlePage(true);
        setShowLookupAddDivBorder(true);
        setShowLookupEditDivBorder(true);
        //    lookupPage();
    }
    ...
    public void setShowEmpSrchDivPaging(boolean showEmpSrchDivPaging) {
        this.ShowEmpSrchDivPaging = showEmpSrchDivPaging;
    }

    public boolean isShowEmpSrchDivPaging() {
        return ShowEmpSrchDivPaging;
    }

    public void setShowTwoVerticalCnt(boolean showTwoVerticalCnt) {
        this.showTwoVerticalCnt = showTwoVerticalCnt;
    }

    public boolean isShowTwoVerticalCnt() {
        return showTwoVerticalCnt;
    }


    public void setShowLookupEditDivBorder(boolean showLookupEditDivBorder) {
        this.showLookupEditDivBorder = showLookupEditDivBorder;
    }

    public boolean isShowLookupEditDivBorder() {
        return showLookupEditDivBorder;
    }

    public void setShowLookupAddDivBorder(boolean showLookupAddDivBorder) {
        this.showLookupAddDivBorder = showLookupAddDivBorder;
    }

    public boolean isShowLookupAddDivBorder() {
        return showLookupAddDivBorder;
    }

    public void setShowCustomDiv3(boolean showCustomDiv3) {
        this.showCustomDiv3 = showCustomDiv3;
    }

    public boolean isShowCustomDiv3() {
        return showCustomDiv3;
    }

    public void setShowNavigationPath(boolean showNavigationPath) {
        this.showNavigationPath = showNavigationPath;
    }

    public boolean isShowNavigationPath() {
        return showNavigationPath;
    }

    public void setShowIntegrationDiv1(boolean showIntegrationDiv1) {
        this.showIntegrationDiv1 = showIntegrationDiv1;
    }

    public boolean isShowIntegrationDiv1() {
        return showIntegrationDiv1;
    }

    public void setShowIntegrationDiv2(boolean showIntegrationDiv2) {
        this.showIntegrationDiv2 = showIntegrationDiv2;
    }

    public boolean isShowIntegrationDiv2() {
        return showIntegrationDiv2;
    }


    public void setShowSearchTreeDiv(boolean showSearchTreeDiv) {
        this.showSearchTreeDiv = showSearchTreeDiv;
    }

    public boolean isShowSearchTreeDiv() {
        return showSearchTreeDiv;
    }

    public void setConditionActivationIntgDiv(boolean conditionActivationIntgDiv) {
        this.conditionActivationIntgDiv = conditionActivationIntgDiv;
    }

    public boolean isConditionActivationIntgDiv() {
        return conditionActivationIntgDiv;
    }


    public void setShowRetroactiveSettDetailsDiv(boolean showRetroactiveSettDetailsDiv) {
        this.showRetroactiveSettDetailsDiv = showRetroactiveSettDetailsDiv;
    }

    public boolean isShowRetroactiveSettDetailsDiv() {
        return showRetroactiveSettDetailsDiv;
    }
