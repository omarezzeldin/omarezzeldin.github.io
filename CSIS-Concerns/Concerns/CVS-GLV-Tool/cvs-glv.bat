...
rmdir /s /q "%MODULE%"
IF  "%BRANCH%" == "head" (
"%CVSEXE%" -d %CVSROOT% checkout -P %MODULE%
) ELSE (
"%CVSEXE%" -d %CVSROOT% checkout -r %BRANCH% -P %MODULE% )

IF [%MODULE_PAGES_PATH%] == [] goto theEnd

IF  "%BRANCH%" == "head" (
"%CVSEXE%" -d %CVSROOT% checkout -P Concerns\JSFBase 

"%CVSEXE%" -d %CVSROOT% checkout -P Concerns\JSFIntegration

"%CVSEXE%" -d %CVSROOT% checkout -P Phase1\Work_Stream_A\Code\DevCode\01-GN\GRS\INTG-PRS

"%CVSEXE%" -d %CVSROOT% checkout -P Phase1\Work_Stream_A\Code\DevCode\01-GN\INF\INTG-PRS

"%CVSEXE%" -d %CVSROOT% checkout -P Phase1\Work_Stream_A\Code\DevCode\02-NL\JOB\INTG-PRS

"%CVSEXE%" -d %CVSROOT% checkout -P Phase1\Work_Stream_A\Code\DevCode\02-NL\QUL\INTG-PRS

"%CVSEXE%" -d %CVSROOT% checkout -P Phase1\Work_Stream_B\Code\DevCode\02-NL\REG\INTG-PRS

"%CVSEXE%" -d %CVSROOT% checkout -P Phase1\Work_Stream_A\Code\DevCode\02-NL\ORG\INTG-PRS

"%CVSEXE%" -d %CVSROOT% checkout -P Phase1\Work_Stream_B\Code\DevCode\03-HR\TRN\INTG-PRS

"%CVSEXE%" -d %CVSROOT% checkout -P Phase1\Work_Stream_B\Code\DevCode\02-NL\BNK\INTG-PRS

"%CVSEXE%" -d %CVSROOT% checkout -P Phase1\Work_Stream_B\Code\DevCode\03-HR\EMP\INTG-PRS

"%CVSEXE%" -d %CVSROOT% checkout -P Phase1\Work_Stream_B\Code\DevCode\03-HR\BGT\INTG-PRS

"%CVSEXE%" -d %CVSROOT% checkout -P Phase1\Work_Stream_B\Code\DevCode\03-HR\DED2\INTG-PRS

"%CVSEXE%" -d %CVSROOT% checkout -P Phase1\Work_Stream_B\Code\DevCode\03-HR\SCP\INTG-PRS

) ELSE (
"%CVSEXE%" -d %CVSROOT% checkout -r %BRANCH% -P Concerns\JSFBase 

"%CVSEXE%" -d %CVSROOT% checkout -r %BRANCH% -P Concerns\JSFIntegration

"%CVSEXE%" -d %CVSROOT% checkout -r %BRANCH% -P Phase1\Work_Stream_A\Code\DevCode\01-GN\GRS\INTG-PRS

"%CVSEXE%" -d %CVSROOT% checkout -r %BRANCH% -P Phase1\Work_Stream_A\Code\DevCode\01-GN\INF\INTG-PRS

"%CVSEXE%" -d %CVSROOT% checkout -r %BRANCH% -P Phase1\Work_Stream_A\Code\DevCode\02-NL\JOB\INTG-PRS

"%CVSEXE%" -d %CVSROOT% checkout -r %BRANCH% -P Phase1\Work_Stream_A\Code\DevCode\02-NL\QUL\INTG-PRS

"%CVSEXE%" -d %CVSROOT% checkout -r %BRANCH% -P Phase1\Work_Stream_B\Code\DevCode\02-NL\REG\INTG-PRS

"%CVSEXE%" -d %CVSROOT% checkout -r %BRANCH% -P Phase1\Work_Stream_A\Code\DevCode\02-NL\ORG\INTG-PRS

"%CVSEXE%" -d %CVSROOT% checkout -r %BRANCH% -P Phase1\Work_Stream_B\Code\DevCode\03-HR\TRN\INTG-PRS

"%CVSEXE%" -d %CVSROOT% checkout -r %BRANCH% -P Phase1\Work_Stream_B\Code\DevCode\02-NL\BNK\INTG-PRS

"%CVSEXE%" -d %CVSROOT% checkout -r %BRANCH% -P Phase1\Work_Stream_B\Code\DevCode\03-HR\MER\INTG-PRS

"%CVSEXE%" -d %CVSROOT% checkout -r %BRANCH% -P Phase1\Work_Stream_B\Code\DevCode\03-HR\EMP\INTG-PRS

"%CVSEXE%" -d %CVSROOT% checkout -r %BRANCH% -P Phase1\Work_Stream_B\Code\DevCode\03-HR\BGT\INTG-PRS

"%CVSEXE%" -d %CVSROOT% checkout -r %BRANCH% -P Phase1\Work_Stream_B\Code\DevCode\03-HR\DED2\INTG-PRS

"%CVSEXE%" -d %CVSROOT% checkout -r %BRANCH% -P Phase1\Work_Stream_B\Code\DevCode\03-HR\SCP\INTG-PRS
)
