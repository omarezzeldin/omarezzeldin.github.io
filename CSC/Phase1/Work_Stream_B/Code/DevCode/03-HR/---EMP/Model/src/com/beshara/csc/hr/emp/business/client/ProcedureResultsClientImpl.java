 ...
 * @since        03/09/2007
 */
public class ProcedureResultsClientImpl extends BaseClientImpl3 implements IProcedureResultsClient {

    
    public ProcedureResultsClientImpl() {
    }
    
    @Override
    protected Class<? extends BasicSession> getSessionInterface() {
        return ProcedureResultsSession.class;
    }
    
    protected ProcedureResultsSession SESSION(){
        return (ProcedureResultsSession)super.SESSION();
    }
