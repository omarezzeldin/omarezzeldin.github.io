...
<f:view locale="#{shared_util.locale}">
    ...
    <h:form id="myForm" binding="#{createInsuranceFileBean.frm}">
   <%--<t:messages showDetail="true" id="msgdetId" forceId="true"/>--%>
        <t:aliasBean alias="#{pageBeanName}" value="#{createInsuranceFileBean}">
            <t:aliasBean alias="#{searchMinistryHelper}" value="#{createInsuranceFileBean.searchMinistryHelper}">
                <tiles:insert definition="createInsuranceFile.page" flush="false"/>
