 ...
 * @since        03/09/2007
 */
public class AllEmployeesClientImpl extends BaseClientImpl3 implements IAllEmployeesClient {

    public AllEmployeesClientImpl() {
    }

    @Override
    protected Class<? extends BasicSession> getSessionInterface() {
        return AllEmployeesSession.class;
    }
    
        protected AllEmployeesSession SESSION(){
            return (AllEmployeesSession)super.SESSION();
        }
