...
<t:panelGrid  align="center">
    <t:panelGroup>
        <t:outputText value="#{detailBeanName.lovBaseBean.errorMsgValue}" forceId="true" id="errorMessag_lov12" styleClass="errMsgNoHeight" />
    </t:panelGroup>
...
<t:panelGrid columns="4" id="lov_searchPanel" align="center" dir="#{shared_util.pageDirection}" forceId="true" width="60%" >
       <%--<h:outputText value="#{resourcesBundle[detailBeanName.titleFlageOfDiv]}"  styleClass="lable01" id="title_Id"/>--%>
    ...
    <t:panelGroup>
        ...
        <a4j:jsFunction name="lov_search" id="lov_search" oncomplete="settingFoucsAtLovDiv();" action="#{detailBeanName.lovBaseBean.searchLovDiv}" reRender="lovDivPanelGroup,lov_dataT_data_panel,lov_paging_panel,lov_searchPanel,lov_errorConsole"  />
    </t:panelGroup>  
       ...
       <t:column id="check_column" styleClass="standardTable_Header3" width="5%">
        ...
        <t:selectOneRadio onkeypress="FireButtonClick('myForm:okLoveButtondiv');" styleClass="radioButton_DataTable"  id="chk" valueChangeListener="#{detailBeanName.lovBaseBean.selectedRadioButton}" value="#{detailBeanName.lovBaseBean.selectedRadio}"  onmousedown="toggleRadio(this);document.getElementById('myForm:okLoveButtondiv').disabled=false;" onkeyup="toggleRadioKeyUpEnableBtn(this,'myForm:okLoveButtondiv');" >
         ...
         <%--a4j:support event="onclick" actionListener="#{detailBeanName.lovBaseBean.selectedRadioButton}"/--%>
            ...
            <t:column id="code_column" sortable="false"  width="#{detailBeanName.jobMode? '45%':'20%'}">
                <f:facet name="header">
                ...
                <h:outputText id="content_code" value="#{detailBeanName.workCenterMode ? list.code.wrkCode : detailBeanName.jobMode ?list.jobKey:list.code.key}"/>
            </t:column>
            
            <t:column id="name_column" sortable="false" width="#{detailBeanName.jobMode? '50%':'75%'}">
                <f:facet name="header">
...
<t:panelGrid columns="2" align="center">
 <h:panelGroup>
 <t:commandButton onclick="OkLovJsFunction();return false;" id="okLoveButtondiv" disabled="true"   value="#{globalResources.ok}" binding="#{detailBeanName.lovBaseBean.okCommandButton}"  styleClass="cssButtonSmall"  onblur="settingFoucsAtLovDiv();" /> 
 <a4j:jsFunction name="OkLovJsFunction" action="#{detailBeanName.lovBaseBean.closeLovDiv}" oncomplete="hideLookUpDiv(window.blocker,window.divLov);" reRender="lovDivPanelGroup,cnt1Panel"/>    
 </h:panelGroup>
 <h:panelGroup>
    ...
    <a4j:jsFunction name="backLovJsFunction" action="#{detailBeanName.lovBaseBean.hideLovDiv}" oncomplete="hideLookUpDiv(window.blocker,window.divLov);foucsFirstElemenyOnPage();" reRender="lovDivPanelGroup"/>    
</h:panelGroup>
