        ...
        <t:dataTable id="dataT_linesStatus" var="list" value="#{pageBeanName.linesResultList}" preserveDataModel="false" renderedIfEmpty="false" footerClass="grid-footer" sortable="false"
            ...
            <t:column sortable="false" width="30%" defaultSorted="true">
                <f:facet name="header">
                 ...
                 <h:outputText  id="actual_line_value_id"  style="#{list.status == 'LineSuccess' ? 'color: #000000' : 'color: RED'}"  value="#{(list.currentObject.actualLineValue == 'null' || list.currentObject.actualLineValue == '-1') ? '-' : list.currentObject.actualLineValue}" /> 
            </t:column>
