...
<t:panelGrid columns="4" id="lov_searchPanel" align="center" dir="#{shared_util.pageDirection}" forceId="true" width="100%" >
...
<t:panelGrid columns="2" align="center">
 <t:commandButton onclick="block();foucsFirstElemenyOnPage();" id="okLoveButtondiv" disabled="true" action="#{detailBeanName.lovBaseBean.closeLovDiv}"  value="#{globalResources.ok}" binding="#{detailBeanName.lovBaseBean.okCommandButton}"  styleClass="cssButtonSmall"  /> 
 ...
 <h:panelGroup>
    ...
    <a4j:jsFunction name="backLovJsFunction" action="#{detailBeanName.hideLovDiv}" oncomplete="hideLookUpDiv(window.blocker,window.divLov);foucsFirstElemenyOnPage();" reRender="lovDivPanelGroup"/>    
</h:panelGroup>
