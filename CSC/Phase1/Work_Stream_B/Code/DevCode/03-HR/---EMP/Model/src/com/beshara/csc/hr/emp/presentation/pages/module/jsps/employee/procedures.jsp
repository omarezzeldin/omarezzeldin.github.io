...
<f:view locale="#{shared_util.locale}">
    ...
    <h:form id="myForm" binding="#{empProceduresBean.frm}">
        <t:aliasBean alias="#{pageBeanName}" value="#{empMaintainBean}">
            <t:aliasBean alias="#{detailBeanName}" value="#{empProceduresBean}">
                <tiles:insert definition="empprocedures.page" flush="false">
                <t:inputHidden id="reportUrl" forceId="true" value="#{detailBeanName.reportUrl}"/>
                    ...
                    <t:saveState value="#{detailBeanName.suspensionReasonsList}"/>
                    <t:saveState value="#{detailBeanName.selectedPageDTO}"/>
                    <t:saveState value="#{detailBeanName.proceduresResultList}"/>
