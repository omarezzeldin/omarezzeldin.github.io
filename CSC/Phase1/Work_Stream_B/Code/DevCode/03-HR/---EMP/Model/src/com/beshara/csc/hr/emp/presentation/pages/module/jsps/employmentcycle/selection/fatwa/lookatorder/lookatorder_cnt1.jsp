...
<t:div id="lookupAddDiv" forceId="true" style="visibility:visible;">
    <t:panelGroup styleClass="review_divMainContent1"
        ...
        <t:panelGrid columns="4" width="100%" border="0" rowClasses="row02,row01" cellpadding="3" cellspacing="0"
            ...
            <%-- Total reward suggested--%>
            <h:outputText value="#{resourcesBundle.total_reward_suggested}" styleClass="divtext" rendered="#{pageBeanName.configBean.renderSuggestSalariesSection}"/>
            <t:panelGroup colspan="3">
                <t:inputText disabled="true" value="#{pageBeanName.totalRewardSuggested}" styleClass="textboxmedium"
                             forceId="true" id="total_reward_suggestedId" rendered="#{pageBeanName.configBean.renderSuggestSalariesSection}"/>
            </t:panelGroup>
            ...
            <t:panelGroup id="acceptJobPanelGrp" forceId="true" colspan="4"
                ...
                <t:inputText disabled="#{pageBeanName.configBean.disableAcceptedJob}"
                             value="#{pageBeanName.acceptedJobName}" tabindex="5" maxlength="12" forceId="true"
            ...
            <t:panelGroup colspan="3" rendered="#{pageBeanName.configBean.disableArrangementDept}">
                <t:inputTextarea  readonly="#{pageBeanName.configBean.disableArrangementDept}"
                                 value="#{pageBeanName.pageDTO.empExtraDataValueDTO.arrangmentDeptNotes}" tabindex="10"
                                 cols="35" rows="4" style="width:650px; height: 50px;" forceId="true"
                                 id="jobs_arrangement_notes"/>
            </t:panelGroup>
            <%-- Start--contract_emp_SAL_equv----%>
            <h:outputText value="#{resourcesBundle.jobs_opinion_notes_label_previous}" styleClass="divtext" rendered="#{pageBeanName.stageId == '9' &&  pageBeanName.pageDTO.previousEmpExtraDataValueDTO.fatwaDeptNotes != null &&  pageBeanName.pageDTO.previousEmpExtraDataValueDTO.fatwaDeptNotes != ' '}"/>
            <t:panelGroup colspan="3" rendered="#{pageBeanName.stageId == '9'  &&  pageBeanName.pageDTO.previousEmpExtraDataValueDTO.fatwaDeptNotes != null &&  pageBeanName.pageDTO.previousEmpExtraDataValueDTO.fatwaDeptNotes != ' '}">
            ...
            <t:panelGroup colspan="3" >
                <t:inputText disabled="true" value="#{pageBeanName.totalRewardAcceptedPrevious}" styleClass="textboxmedium"/>
            </t:panelGroup>           
            ...
            <t:panelGroup rendered="#{pageBeanName.configBean.renderSalariesSection}">
                ...
                <t:panelGroup id="employeeCaderPanel" forceId="true"
                    ...
                    <a4j:commandButton value="#{globalResources.Available}" id="button" styleClass="cssButtonSmaller"
                                       action="#{fatwaReviewListBean.showCaderListOfValuesDiv}"
            ...
            <t:panelGroup rendered="#{pageBeanName.configBean.renderSalariesSection}">
                <t:panelGroup id="jobs_group" forceId="true">
                    <t:inputText disabled="#{pageBeanName.configBean.disableJobGroup}"
                                 ...
                                 tabindex="12" maxlength="12" forceId="true" id="candidate_jobs_group"
                                 styleClass="textboxmedium" style="width: 225px;"/>
            ...
            <t:panelGroup id="degreePanel" forceId="true" rendered="#{pageBeanName.configBean.renderSalariesSection}">
                <t:inputText disabled="#{pageBeanName.configBean.disableSalDegree}"
                             ...
                             tabindex="13" maxlength="12" forceId="true" id="candidate_sal_degree2"
                             styleClass="textboxmedium"/>
                <t:selectOneMenu forceId="true"
                    ...
                    <a4j:support reRender="raisesCount_Id,degreePanel" event="onchange" action="#{pageBeanName.onDegreeChangedRaise}"/>
                </t:selectOneMenu>
            ...
            <%-- Total_reward_accepted--%>
            <h:outputText value="#{resourcesBundle.total_reward_accepted}" styleClass="divtext" rendered="#{pageBeanName.configBean.renderSalariesSection}"/>
            <t:panelGroup colspan="3" id="rewardsPG" forceId="true" rendered="#{pageBeanName.configBean.renderSalariesSection}">
                ...
                <h:commandButton value="#{resourcesBundle.allowance_bounses}" id="rewardsbtnId" styleClass="cssButtonSmaller"
                                 action="#{pageBeanName.addBounses}" disabled="#{!pageBeanName.enableAddRewardButton}"/>
            </t:panelGroup>
            <h:outputText value="#{resourcesBundle.jobs_opinion_notes_label}" styleClass="divtext"
        ...
        <t:panelGrid border="0" columns="4" align="center">
            <%-- -Contract-- review_Degree&Job_inprogress(9)--%>
            <t:commandButton styleClass="cssButton" tabindex="15" rendered="#{pageBeanName.configBean.renderbtnGrp1}"
                             action="#{pageBeanName.biznasActions.transferForJobArrangmentAction}"
                             value="#{resourcesBundle.transefer_request_arrangment_btn}" onclick="block();"/>
                             
         
            <t:commandButton styleClass="cssButtonSmall" tabindex="16"
                             rendered="#{pageBeanName.configBean.renderbtnGrp2}"
                             action="#{pageBeanName.biznasActions.saveSalaryDegreeAction}"
           ...
           <t:panelGrid columns="1" border="0" align="center"  rendered="#{!pageBeanName.configBean.renderbtnGrp1}">
            ...
            <t:commandButton styleClass="cssButtonMedium" tabindex="17"
                             action="#{pageBeanName.biznasActions.replyRequestForUpdateDataActionForContract}"
                             value="#{resourcesBundle.transefer_request_ministry_btn}"
                             onclick="block();"/>
            <t:commandButton styleClass="cssButtonSmall" id="backButtonAddDiv" forceId="true" tabindex="18"
