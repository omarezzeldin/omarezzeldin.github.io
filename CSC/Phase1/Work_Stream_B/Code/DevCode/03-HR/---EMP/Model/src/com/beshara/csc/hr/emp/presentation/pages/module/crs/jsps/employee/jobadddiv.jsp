...
<t:panelGroup rendered="#{detailBeanName.renderJobDiv}" >
    ...
    <t:panelGrid  align="center" dir="#{shared_util.pageDirection}" forceId="true" width="80%" columns="5" id="searchPanel2" >             
            ...
            <t:panelGroup forceId="true" id="divAddPopup" styleClass="delDivScroll">
                 ...
                 <t:panelGrid rendered="#{detailBeanName.pagingBean.totalListSize == 0}" align="center" styleClass="msg">
...
<t:panelGrid columns="1" forceId="true" id="scrollerPanel_popup">
  <h:panelGrid id="panelGrd_scrolleradd_popup" columns="1" dir="#{shared_util.pageDirection}" styleClass="scroller" width="300px" rendered="#{detailBeanName.jobListSize > shared_util.noOfTableRows}">
          <t:dataScroller 
                    id="scroll_1add_job"     
...
<h:panelGroup>
    ...
    <a4j:jsFunction name="backDelConfirmJsFunction" action="#{detailBeanName.hideJobDiv}" oncomplete="hideLookUpDiv(window.blocker,window.delAlert,null,null);foucsFirstElemenyOnPage(); " reRender="jobDivPanelGroup"/>
</h:panelGroup>
