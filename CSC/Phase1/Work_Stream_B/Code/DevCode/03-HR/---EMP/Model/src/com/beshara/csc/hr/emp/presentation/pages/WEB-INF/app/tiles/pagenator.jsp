...
<t:panelGroup forceId="true" id="paging_panel">
        <h:panelGrid id="panelGrd_scroller" columns="1" dir="#{shared_util.pageDirection}" styleClass="scroller" width="300px" rendered="#{pageBeanName.listSize > shared_util.noOfTableRows}" >
