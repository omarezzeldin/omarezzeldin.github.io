...
<t:panelGrid columns="6" rowClasses="row01,row02" width="100%" cellpadding="3" cellspacing="0" border="0" >
    ...
    <%--- Start of Row 2--%>
      ...
      <t:panelGroup colspan="5" rendered="#{pageBeanName.maintainMode == 0}">
        ...
        <%--<t:outputText forceId="true" id="codeText" styleClass="divtext"  value="#{regResources.merSection}"/>--%>
        <%--<t:panelGroup colspan="5" id="detail_sal_elm_guide" forceId="true">
           <t:inputText id="dtl_sal_elm_guide_code"  styleClass="textboxsmall" forceId="true" value="#{detailBeanName.selectedElementGuideCode}"  disabled="#{pageBeanName.showOnly}" tabindex="1"
            ...
            <a4j:commandButton value="..." styleClass="cssButtonSmaller" action="#{detailBeanName.openTreeDiv2}" disabled="#{pageBeanName.showOnly}"
        ...
        <t:panelGroup  onkeypress="FireButtonClickOldStyle(event,'addEmp');"  id="merDurationFromPnl" forceId="true" colspan="1">
        ...
        <t:outputText forceId="true" id="merDurationTo" styleClass="divtext" value="#{regResources.merDurationTo}"/>
         <f:verbatim>&nbsp;&nbsp; </f:verbatim>
            <t:inputCalendar   onkeypress="FireButtonClickOldStyle(event,'addEmp');" value="#{pageBeanName.pageDTO.decMerToDate}" id="clndr_merDurationToDate"
                title="#{globalResources.inputCalendarHelpText}" popupButtonImageUrl="/app/media/images/icon_calendar.jpg" 
                popupDateFormat="dd/MM/yyyy" forceId="true" maxlength="10" currentDayCellClass="currentDayCell"
                styleClass="textbox" renderAsPopup="true"
                align="#{globalResources.align}" popupLeft="#{shared_util.calendarpopupLeft}" renderPopupButtonAsImage="true" 
       ...
       <h:outputText value="#{regResources.civil_id}" rendered="#{!pageBeanName.showOnly}" />  
       <t:panelGroup colspan="5" rendered="#{!pageBeanName.showOnly}" >
            <t:inputText  tabindex="2" styleClass="textboxsmall2" value="#{detailBeanName.civilID}" maxlength="12" forceId="true" id="civilIdInTxt" converter="javax.faces.Long" onkeyup="disableCharacters(this);" onkeypress="FireButtonClickOldStyle(event,'addEmp');"  disabled="#{pageBeanName.showOnly}"/>
            <a4j:commandButton type="button" value="#{globalResources.SearchButton}" styleClass="cssButtonSmallest"
               tabindex="3" disabled="#{pageBeanName.showOnly}" oncomplete="changeVisibilityDiv(window.blocker,window.lovEmp);settingFoucsAtEmpLovDiv();"
               action="#{detailBeanName.showSearchForEmployeeDivBSN}" reRender="lovEmp" />   
            <h:outputText value="*" styleClass="mandatoryAsterisk" rendered="#{pageBeanName.maintainMode == 0}"/>
            <t:commandButton tabindex="5" id="addEmp" forceId="true" value="#{globalResources.addButton}" styleClass="cssButtonSmall" disabled="#{pageBeanName.showOnly}"
                                   action="#{detailBeanName.findEmployeeByCivilIDFromEmployees}"  onclick="return ( validatemyForm('empCivil') && validatemyForm('empData') );jumpToNextField('civilIdInTxt');" />
            <f:verbatim><br/></f:verbatim>
        ...
        <%--<t:panelGroup colspan="4" >  
            ...
            <t:inputText tabindex="4" onkeypress="FireButtonClickOldStyle(event,'addEmp');" forceId="true" id="fels_number1"  value="#{detailBeanName.felsValue}"  onkeyup="disableCharacters(this);" maxlength="3"  styleClass="textbox" style="width:30px;"   disabled="#{pageBeanName.showOnly}" />
            <f:verbatim>&nbsp; </f:verbatim>
            <t:inputText tabindex="3" onkeypress="FireButtonClickOldStyle(event,'addEmp');" forceId="true" id="denar_number1" value="#{detailBeanName.dinarValue}" onkeyup="disableCharacters(this);" maxlength="8"  styleClass="textbox"   style=" width: 50px;  margin-right: 4px; margin-left: 1px;"   disabled="#{pageBeanName.showOnly}" />
            <f:verbatim>&nbsp;&nbsp; </f:verbatim>
           <f:verbatim><br/></f:verbatim>
           <t:outputText id="errorCivilMessage1" forceId="true" styleClass="errMsg" value="#{detailBeanName.civil_exist}"/>
            <t:outputText id="errorCivilMessage" forceId="true" styleClass="errMsg"/>
            ...
            <c2:regularExpressionValidator group="empCivil"  componentToValidate="civilIdInTxt" 
                ...
                highlight="false"  display="dynamic" active="#{delegationDecisionMainDataMaintainBean.divflag==false}"/>--%><%--active="#{!stopSalaryListBean.civilExist}"--%><%--
