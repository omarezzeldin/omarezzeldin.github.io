...
<t:panelGroup forceId="true" id="dataT_data_panel" styleClass="dataT-With-4-row-filter"  style="display: block; max-height: 312px; min-height: 30px; overflow: auto; width: 100%;">
    <t:dataTable id="dataT_data" var="list" renderedIfEmpty="false" value="#{detailBeanName.currentDisplayDetails}"
        ...
        <t:column id="Id" width="10%" sortable="false">
            <f:facet name="header">
        ...
        <t:column id="document_status" width="13%">
            <f:facet name="header">
        ...
        <t:column id="attachemnet_status" width="13%">
            ...
            <t:selectBooleanCheckbox forceId="true" id="attachmentStatusFlag" value="#{list.attachmentStatusFlag}" disabled="#{list.attachmentStatusEnabled}" >
        ...
        <t:column id="attachemnet" width="13%">
            ...
            <t:commandButton id="SaveButton" forceId="true" value="..." styleClass="cssButtonSmall" action="#{detailBeanName.addIntegrationDocument}" disabled="#{list.attachmentStatusEnabled}" />
        </t:column>
    </t:dataTable>
...
<%--<t:outputText id ="hanyId" value="#{mainDataCandidateBean.civilExist}"/>--%>