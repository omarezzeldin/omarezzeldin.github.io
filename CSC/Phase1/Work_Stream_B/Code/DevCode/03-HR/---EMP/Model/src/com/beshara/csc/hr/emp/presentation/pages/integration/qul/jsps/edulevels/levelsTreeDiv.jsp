...
<t:panelGroup forceId="true" id="eduLevelTeeDiv">
    ...
    <t:panelGrid columns="2" align="center">
        <h:panelGroup id="okEduLevelPanel">
            <t:commandButton id="treeEduLevelDivOkBtn"
                               ...
                               onclick="hidTreeDiv(null,window.blocker,window.#{qulEduLevelsIntegrationBean.intDivName},null);"/>
            
        </h:panelGroup>
        <t:panelGroup>
            <t:commandButton type="button" forceId="true" id="lov_cancel"
