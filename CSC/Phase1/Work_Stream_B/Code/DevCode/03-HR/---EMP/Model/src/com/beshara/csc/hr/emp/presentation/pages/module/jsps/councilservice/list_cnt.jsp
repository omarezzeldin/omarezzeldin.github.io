...
<%@ taglib uri="http://jsftutorials.net/htmLib" prefix="htm"%>
 <htm:style> .dataT-With-2-row-filter{
	width: 874px !important;
}
     </htm:style>

<t:panelGroup id="dataT_data_panel" forceId="true" styleClass="dataT-With-2-row-filter">
    <t:dataTable id="dataT_data" var="list"
                 ...
                 rowClasses="standardTable_Row1,standardTable_Row2" style="width: 980 !important;"
        ...
        <t:column id="KwtCitizenNo_column" width="130">
            <f:facet name="header">
                <t:outputText value="#{resourcesBundle.kwtCitizensRegisteredOnQualification}" id="KwtNo"/>
            </f:facet>
            <h:outputText id="content_KwtCitizenNo" value="#{pageBeanName.noKwtCitOnQual}"/>
        </t:column>
