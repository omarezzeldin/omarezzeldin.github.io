...
<t:panelGrid id="options_panel" width="100%" border="0" cellpadding="3" cellspacing="0" rowClasses="row01">
    <t:selectOneRadio id="options" value="#{pageBeanName.calcPageMode}"  style="text-align: center; margin: 0px auto;">
        <f:selectItem itemValue="#{pageBeanName.centeralEmployment}" itemLabel="#{resourcesBundle.centralcandidate}"/>
        <f:selectItem itemValue="#{pageBeanName.contracts}" itemLabel="#{resourcesBundle.contractcandiate}"/>
        <a4j:support event="onclick" actionListener="#{pageBeanName.updatePageMode}"
                         reRender="dataT_data,scriptGenerator,proceedCandidateContinerEmp,centeralEmploymentinputid,paging_panel_group,listSize,divMsg,dataT_data_panel, OperationBar, paging_panel,errorCodePanelId,errorCodePanelId2,categoryId,categoryList,ministryListID,ministryId"/>
        ...
        <t:panelGrid columns="4" id="proceedCandidateContinerEmp" rowClasses="row02,row01" width="100%" border="0" cellpadding="3" cellspacing="0"
            ...
            <t:selectOneMenu id="candTypesList1" tabindex="1" onkeydown="onKeyDownFirstElement(event,'categoryId','ministryListID')" forceId="true" styleClass="DropdownboxxLarge2" style="width: 336px;"
                             value="#{pageBeanName.selectedStageId}"
                             rendered="#{pageBeanName.contractActive == false">
                <f:selectItem itemValue="#{pageBeanName.stageIdCompletingJobName}"
                              itemLabel="#{resourcesBundle.completingJobName}"/>
                <f:selectItem itemValue="#{pageBeanName.stageIdFinDegreeRequired}"
                ...
                <f:selectItem itemValue="#{pageBeanName.stageIdRejectedByJobsArrangementDeptAndRejectedByFatwaDept}"
                              itemLabel="#{resourcesBundle.requestResponseHasBeen}"/>               
                <a4j:support event="onchange" reRender="paging_panel_group,listSize,divMsg,dataT_data,dataT_data_panel, OperationBar, paging_panel,errorCodePanelId,errorCodePanelId2,categoryId,categoryList,ministryListID,ministryId"
            ...
            <a4j:jsFunction name="changeCategoryValD" actionListener="#{pageBeanName.filterByCategory}" oncomplete="resetMinistry();" reRender="OperationBar,ministryListID,ministryId,listSize,dataT_data_panel,paging_panel_group,errorCodePanelId,errorCodePanelId2,paging_panel"/>
            </t:selectOneMenu>                      
            ...
            <h:outputText id="ministry_name" value="#{resourcesBundle.emp_internal_exp_minName}" styleClass="lable01"/>
             ...
             <t:inputText forceId="true" id="ministryId" tabindex="4" styleClass="filteration_input_text"
                 ...
                 onkeyup="enabelIntegerOnly(this);" style="margin-left:5px;">  
             <%--<a4j:jsFunction name="changeMinistryVal" actionListener="#{pageBeanName.filterByMinistry}" oncomplete="copyDropdownIntoInputtext('ministry', 'ministryId');" reRender="OperationBar,listSize,dataT_data_panel,paging_panel_group"/>--%>
                 <a4j:jsFunction name="changeMinistryVal" actionListener="#{pageBeanName.filterByMinistry}" oncomplete="copyDropdownIntoInputtext('ministryId', 'ministryId');" reRender="OperationBar,listSize,dataT_data_panel,paging_panel_group,paging_panel,errorCodePanelId2"/>
            ...
            <t:selectOneMenu id="ministryListID" forceId="true" tabindex="5" styleClass="DropdownboxLarge"
                ...
                <t:selectItems value="#{pageBeanName.ministryList}" var="ministryList"
                 ...
                 <a4j:jsFunction name="changeMinistryValD" actionListener="#{pageBeanName.filterByMinistry}" oncomplete="copyDropdownIntoInputtext('ministryId', 'ministryId');" reRender="OperationBar,listSize,dataT_data_panel,paging_panel_group,paging_panel,errorCodePanelId2"/>
