...
import com.beshara.csc.hr.emp.business.deploy.IncomeDataSession;
 ...
 * @since 03/09/2007
 */
public class IncomeDataClientImpl extends BaseClientImpl3 implements IIncomeDataClient {


    public IncomeDataClientImpl() {
        super();
    }
    ...
    protected Class<? extends BasicSession> getSessionInterface() {
        return IncomeDataSession.class;
    }

    @Override
    protected IncomeDataSession SESSION() {
        return (IncomeDataSession)super.SESSION();
    }
