 ...
 * <b>Description:</b>
 * <br>&nbsp;&nbsp;&nbsp;
 * This Class Manipulate the Persistence Methods of RaiseDataLog Entity.
 * <br><br>
...
@Entity
@NamedQueries({
@NamedQuery(name = "RaiseDataLogEntity.findAll", query = "select o from RaiseDataLogEntity o"),
@NamedQuery(name = "RaiseDataLogEntity.findNewId", query = "select MAX(o.civilId) from RaiseDataLogEntity o")
})
@Table(name = "HR_EMP_RAISE_DATA_LOG")
public class RaiseDataLogEntity extends BasicEntity {
...
private String calcFunction;
    ...
    /**
     * RaiseDataLogEntity Default Constructor
     */    
    public RaiseDataLogEntity() {
    }
