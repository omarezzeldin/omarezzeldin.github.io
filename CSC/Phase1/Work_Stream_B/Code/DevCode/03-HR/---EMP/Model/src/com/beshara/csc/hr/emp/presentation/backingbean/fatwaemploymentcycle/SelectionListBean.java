...
import com.beshara.csc.hr.emp.presentation.backingbean.jobsArr.EmployeeListOfValues;
...
public class SelectionListBean extends LookUpBaseBean {
    ...
    private static final String SELECTION_BEAN_NAME = "fatwaSelectionListBean";
    ...
    private static final String HIRE_STAGE_REJECTED_BY_JOBS_ARRANGEMENT_AND_REJECTED_BY_FATWA = "1416";
    ...
    private static final String LIST_PAGE = "backToFatwaSelection";
    private boolean approveBtnShow = true;
    ...
    private void intializeSearchDTO() {
        ...
        if (getCalcPageMode().equals(IEMPConstants.CENTRAL_EMPLOYEMENT.toString())) {
            ...
            setSelectedStageId(getStageIdRejectedByJobsArrangementDept());
        } else {
    ...
    public void reloadDataForReviewListBean() {
        ReviewListBean reviewListBean = (ReviewListBean)evaluateValueBinding("fatwaReviewListBean");
    ...
    private void showAcceptSalaryDegreeCrs(ReviewListBean reviewListBean, IEmpCandidatesDTO empDTO, Long extraDataType) {
        if (empDTO.getEmpCandidateExtraDataList() != null) {
            ISalElementGuidesDTO raiseDTO = SalDTOFactory.createSalElementGuidesDTO();
            ISalElementGuidesDTO degreeDTO = SalDTOFactory.createSalElementGuidesDTO();
            ISalElementGuidesDTO groupDTO = SalDTOFactory.createSalElementGuidesDTO();
...
//            String previousNote = ""; 
//            String currentNote="";
//            if( empDTO.getPreviousEmpExtraDataValueDTO() != null && empDTO.getPreviousEmpExtraDataValueDTO().getFatwaDeptNotes() != null){
//                 previousNote=empDTO.getPreviousEmpExtraDataValueDTO().getFatwaDeptNotes();
//                }
//            if( empDTO.getEmpExtraDataValueDTO() != null && empDTO.getEmpExtraDataValueDTO().getFatwaDeptNotes() != null){
//                 currentNote=empDTO.getEmpExtraDataValueDTO().getFatwaDeptNotes();
//                }
//            if(currentNote.trim().equals("") && !previousNote.trim().equals("")){
//                    empDTO.getEmpExtraDataValueDTO().setFatwaDeptNotes(previousNote);
//                }
...
//                                               }
//                                               
//                                               reviewListBean.fillRaiseCRSList();
//                                               
//                                           }
//                                       }    
//                                   }
//                }
    ...
    private void showAcceptSalaryDegree(ReviewListBean reviewListBean, IEmpCandidatesDTO empDTO, Long extraDataType) {
        if (empDTO.getEmpCandidateExtraDataList() != null) {
           // reviewListBean.setEmpCandExtraDataList((List)empDTO.getEmpCandidateExtraDataList());
            ISalElementGuidesDTO raiseDTO = SalDTOFactory.createSalElementGuidesDTO();
            ISalElementGuidesDTO degreeDTO = SalDTOFactory.createSalElementGuidesDTO();
            ISalElementGuidesDTO groupDTO = SalDTOFactory.createSalElementGuidesDTO();
           Float totalRewardAccepted=0F;
            Float totalRewardNotBasicSal=0F;
...
//                                            (ISalElementGuidesDTO)SalClientFactory.getSalElementGuidesClient().getElmGuideByCode(Long.parseLong(reviewListBean.getRaiseCode()));
//                                    reviewListBean.setRaiseName(String.valueOf(raiseDTO.getCountGuide()));
//                                    reviewListBean.setRaiseDTO(raiseDTO);
//                                }
//                                //degree
//                                if (raiseDTO.getParentObject() != null && raiseDTO.getParentObject().getCode() != null) {
//                                    reviewListBean.setDegreeCode(((ISalElementGuidesEntityKey)raiseDTO.getParentObject().getCode()).getElmguideCode());
...
//                                if (list.getValueDesc() != null && !list.getValueDesc().equals("")){
//                                    totalRewardAccepted += Float.valueOf(list.getValueDesc());
//                                  reviewListBean.setEnableAddRewardButton(true);
//                                }
//                            }else  if (((EmpExtraDataTypesEntityKey)list.getEmpExtraDataTypesDTO().getCode()).getExtdattypeCode().equals(21L)) {
//                                totalRewardAccepted += Float.valueOf(list.getValueDesc());
//                                totalRewardNotBasicSal+=Float.valueOf(list.getValueDesc());
//                                AddBounceBean addBounceBean = AddBounceBean.getInstance();
//                                addBounceBean.setTotalBouncseNotBasicSal(totalRewardNotBasicSal);
//                                if (addBounceBean.getMyTableData() == null) {
//                                    addBounceBean.setMyTableData(new ArrayList());
//                                }
...
//                                ISalElementGuidesEntityKey ek=SalEntityKeyFactory.createSalElementGuidesEntityKey(Long.valueOf(list.getValue()));
//                             salElementGuidesDTO = (ISalElementGuidesDTO)SalClientFactory.getSalElementGuidesClient().getById(ek);
//                                salElementGuidesDTO.setValue(Float.valueOf(list.getValueDesc()));
//                                salEmpSalaryElementsDTO.setSalElementGuidesDTO(salElementGuidesDTO);
//                                addBounceBean.getMyTableData().add(salEmpSalaryElementsDTO);
//                            }
//                        }
//                    }
//                }
                    ...
                    if (empDTO.getPreviousEmpCandidateExtraDataList() != null) {
                        ...
                        for (IBasicDTO basicDTO : empDTO.getPreviousEmpCandidateExtraDataList()) {
                            ...
                            if (extraDataType != null) {
                                ...
                                reviewListBean.setTotalRewardAcceptedPrevious(totalRewardAccepted.toString());
                            }
                        }
                    }
                }
                ...
                reviewListBean.setTotalRewardAccepted(totalRewardAccepted.toString());
    ...
    private void showJobAndBudgetType(ReviewListBean reviewListBean, IEmpCandidatesDTO empDTO) {
        if (empDTO.getEmpCandidateExtraDataList() != null) {
            try {
                ...
                boolean existTotalRewardSuggested = false;
                for (IBasicDTO basicDTO : empDTO.getEmpCandidateExtraDataList()) {
                    ...
                    if (((EmpExtraDataTypesEntityKey)employeeExtraDataDTO.getEmpExtraDataTypesDTO().getCode()).getExtdattypeCode().equals(IEMPConstants.EX_DATA_BGT_TYPE)) {
                    ...
                    } else if (((EmpExtraDataTypesEntityKey)employeeExtraDataDTO.getEmpExtraDataTypesDTO().getCode()).getExtdattypeCode().equals(IEMPConstants.EX_DATA_JOB_ACCEPTED)) {
                        ...
                        existJob = true;
                    } else if (((EmpExtraDataTypesEntityKey)employeeExtraDataDTO.getEmpExtraDataTypesDTO().getCode()).getExtdattypeCode().equals(IEMPConstants.EX_DATA_JOB_SUGGESTED)) {
                        IJobsEntityKey entitKey =
                            JobEntityKeyFactory.createJobsEntityKey(employeeExtraDataDTO.getValue());
                        IJobsDTO jobDTO = (IJobsDTO)JobClientFactory.getJobsClient().getById(entitKey);
                        reviewListBean.setJobNameForMin(jobDTO.getName());
                        existJobNameForMin = true;
                    } else if (((EmpExtraDataTypesEntityKey)employeeExtraDataDTO.getEmpExtraDataTypesDTO().getCode()).getExtdattypeCode().equals(IEMPConstants.EX_DATA_REWARD_SUGGESTED)) {
                        reviewListBean.setTotalRewardSuggested(employeeExtraDataDTO.getValue());
                        existTotalRewardSuggested = true;
                ...
                if (!existJob) {
                    if (empDTO.getJobsDTO() != null)
                        empDTO.getJobsDTO().setName(null);
                }
                if (!existJobNameForMin) {
                    reviewListBean.setJobNameForMin("");
                }
                if (!existTotalRewardSuggested) {
                    reviewListBean.setTotalRewardSuggested("");
                }
            } catch (Exception e) {
                e.printStackTrace();
            }
    ...
    public void fillDataByStage(IEmpCandidatesDTO empDTO, ReviewListBean reviewListBean, String stage) {
        ...
        case HireStageConst.HIRE_STAGE_FIN_DEGREE_REQUIRED:
            displaySalaryDegreeForContract(reviewListBean, empDTO);
            showJobAndBudgetType(reviewListBean, empDTO); // show budgetType
            showAcceptSalaryDegree(reviewListBean, empDTO, IEMPConstants.EX_DATA_CADER_ACCEPTED);
            break;
    ...
    public String switchReviewListAction() {
        if (getCalcPageMode().equals(IEMPConstants.CENTRAL_EMPLOYEMENT.toString())) {
            //  return null;
            // To Do M.abdelsabour
            return viewReviewListActionCenteralEmployement();

        } else {
            return viewReviewListAction();
        }
    }
    
    public String switchReviewApproveAction() {
        if (getCalcPageMode().equals(IEMPConstants.CENTRAL_EMPLOYEMENT.toString())) {
            //  return null;
            // To Do M.abdelsabour
            return viewReviewApproveActionCenteralEmployement();

        } else {
            return viewReviewApproveAction();
        }
    }
    ...
    public String viewReviewListAction() {
        ...
        IEmpCandidatesDTO empDTO;
            ...
            if (getCalcPageMode().equals(IEMPConstants.CONTRACTS.toString()) &&
                getSelectedStageId().equals(IEMPConstants.HIRE_STAGE_FIN_DEGREE_REQUIRED_INPROGRESS)) {
            ...
            reviewListBean.setBckBtnNavigationCase("fatwaSelectionListPage");
            ...
            return "fatwaReviewRequestPage";  

    }
    
    
    public String viewReviewApproveAction() {
        ReviewListBean reviewListBean = (ReviewListBean)evaluateValueBinding("fatwaReviewListBean");
        IEmpCandidatesDTO empDTO;
            try{
            empDTO = makeEmployeeDTO(getSelectedDTOS().get(0).getCode());
...
//            }
    ...
    public void fillDataTableByStageId() {
        ...
        if (getSelectedStageId() != null) {
            ...
            if(getSelectedStageId().equals(IEMPConstants.HIRE_STAGE_FIN_DEGREE_REQUIRED_INPROGRESS)){
                approveBtnShow=true;
            }else if(getSelectedStageId().equals(IEMPConstants.HIRE_STAGE_REVIEW_ORDER_IN_SELECTION_INPROGRESS) || getSelectedStageId().equals(IEMPConstants.HIRE_STAGE_REJECTED_BY_JOBS_ARRANGEMENT)){
                approveBtnShow=false;
                }
            
            if (!getSelectedStageId().equals("")) {
                searchDTO1.setExperienceCheck(IEMPConstants.HAS_EXPERIENCE);
                searchDTO1.setMangeId(IEMPConstants.FATWA_MANAGER);
                if (getCalcPageMode().equals(IEMPConstants.CONTRACTS.toString())) {
                ...
                if (getSelectedStageId().equals(HIRE_STAGE_REJECTED_BY_JOBS_ARRANGEMENT_AND_REJECTED_BY_FATWA)) {
    ...
    public String getStageIdRejectedByJobsArrangementDeptAndRejectedByFatwaDept() {
        return HIRE_STAGE_REJECTED_BY_JOBS_ARRANGEMENT_AND_REJECTED_BY_FATWA;
    }
...
//        }
        ...
        // IEmployeesearchDTO1 searchDTO1 ;
        //= EmpDTOFactory.createEmployeesearchDTO1();
    ...
    public void updatePageMode(ActionEvent ae) {
        ...
        if (getCalcPageMode().equals(IEMPConstants.CENTRAL_EMPLOYEMENT.toString())) {
            ...
            setSelectedStageId(getStageIdReviewInDewan());
            searchDTO1.setEmpHireTypes(null);
            approveBtnShow=false;
    ...
    // new Added by M.abdelsabour for Centeral Employment

    public String viewReviewListActionCenteralEmployement() {
        ReviewListBean reviewListBean = (ReviewListBean)evaluateValueBinding("fatwaReviewListBean");
        IEmpCandidatesDTO empDTO;
        try {
            try{
            ...
            showAcceptSalaryDegreeCrs(reviewListBean, empDTO, 14L); // accepted Salary Degree
            reviewListBean.setHasExperience(empDTO.isHasExperience());
            reviewListBean.setHireSystemMode(getCalcPageMode());
            reviewListBean.setBckBtnNavigationCase("fatwaSelectionListPage");
            reviewListBean.getSaveStateList().add(getSelectedStageId());
            ...
            return "fatwaCenteralEmployment";
        } catch (SharedApplicationException e) {
            e.printStackTrace();
            getSharedUtil().handleException(e);
        } catch (DataBaseException e) {
    ...
    public String viewReviewApproveActionCenteralEmployement() {
        ReviewListBean reviewListBean = (ReviewListBean)evaluateValueBinding("fatwaReviewListBean");
        IEmpCandidatesDTO empDTO;
        try {
            try{
            ...
            return "fatwaCenteralEmploymentApprove";
        } catch (SharedApplicationException e) {
            e.printStackTrace();
            getSharedUtil().handleException(e);
        } catch (DataBaseException e) {
    ...
    public String viewDocuments() {
        if (this.getSelectedDTOS() != null && this.getSelectedDTOS().size() == 1) {
            ...
            viewDocuments.setBckBtnNavigationCase("fatwaSelectionListPage");
        }
    ...
    public String addIntegrationDocument() {
        ...
        getIntegrationBean().setNavgationCaseFrom("backToFatwaSelection");
        getIntegrationBean().setBeanNameFrom("fatwaSelectionListBean");
        ...
        Long docTypeCode = IEMPConstants.Attachment_FATWA;

        String fullName = empDTO.getCitizensResidentsDTO().getName();
        String docTypeName = getSharedUtil().messageLocator(BUNDLE_NAME, "fatwa_attachment");
        ...
        getAddDocAttachmentsIntegrationBean().setBckBtnNavigationCase("backToFatwaSelection");
    ...
    public void showSearchForEmployeeDiv() {
        ...
        employeeListOfValuesBean.setReturnMethodName("fatwaSelectionListBean.returnMethodAction");
