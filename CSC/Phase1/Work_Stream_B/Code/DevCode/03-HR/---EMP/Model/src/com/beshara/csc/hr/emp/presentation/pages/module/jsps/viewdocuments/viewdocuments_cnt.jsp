    ...
    <t:panelGroup forceId="true" id="dataT_data_panel">
        <t:dataTable id="dataT_data" var="list" value="#{pageBeanName.myTableData}"
            ...
            <t:column id="Id" width="10%" sortable="false">
                <f:facet name="header">
                    <t:commandLink id="sort_documentTypeDTO-code-doctypeCode" forceId="true" styleClass="headerLink"
                        ...
                        <t:graphicImage value="#{(pageBeanName.sortAscending&&pageBeanName.fullColumnName=='documentTypeDTO-code-doctypeCode') ? '/app/media/images/ascending-arrow.gif' :''}"
                                        border="0"/>
                        <t:graphicImage value="#{(!pageBeanName.sortAscending&&pageBeanName.fullColumnName=='documentTypeDTO-code-doctypeCode') ? '/app/media/images/descending-arrow.gif' :''}"
                                        border="0"/>
                    </t:commandLink>
                </f:facet>
            ...
            <t:column id="typeTitle" width="20%" sortable="false">
                <f:facet name="header">
                    <t:commandLink id="sort_documentTypeDTO-name" forceId="true" styleClass="headerLink"
                        ...
                        <t:graphicImage value="#{(pageBeanName.sortAscending&&pageBeanName.fullColumnName=='documentTypeDTO-name') ? '/app/media/images/ascending-arrow.gif' :''}"
                                        border="0"/>
                        <t:graphicImage value="#{(!pageBeanName.sortAscending&&pageBeanName.fullColumnName=='documentTypeDTO-name') ? '/app/media/images/descending-arrow.gif' :''}"
                                        border="0"/>
                    </t:commandLink>
                </f:facet>
            ...
            <t:column id="attachemnet" width="13%">
                ...
                <t:commandButton id="SaveButton" forceId="true" value="..." styleClass="cssButtonSmall"
                                 action="#{pageBeanName.addIntegrationDocument}"/>
            </t:column>
        </t:dataTable>
