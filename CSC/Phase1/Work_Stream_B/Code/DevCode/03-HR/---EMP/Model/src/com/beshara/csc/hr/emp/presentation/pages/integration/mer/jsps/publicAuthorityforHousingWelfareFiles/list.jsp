...
<f:view locale="#{shared_util.locale}">
    ...
    <h:form id="myForm" binding="#{housingWelfareFilesBean.frm}">
   <%--<t:messages showDetail="true" id="msgdetId" forceId="true"/>--%>
            <t:aliasBean alias="#{pageBeanName}" value="#{housingWelfareFilesBean}">
            <t:aliasBean alias="#{searchMinistryHelper}" value="#{housingWelfareFilesBean.searchMinistryHelper}">
                <tiles:insert definition="housingWelfareFiles.page" flush="false"/>
