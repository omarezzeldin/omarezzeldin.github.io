 ...
 */
@Remote
public interface HireStatusSession extends BasicSession { // Add your extra methods 
    
    
    public List<IBasicDTO> getCodeName(IRequestInfoDTO ri) throws RemoteException,SharedApplicationException, 
                                            DataBaseException ;
