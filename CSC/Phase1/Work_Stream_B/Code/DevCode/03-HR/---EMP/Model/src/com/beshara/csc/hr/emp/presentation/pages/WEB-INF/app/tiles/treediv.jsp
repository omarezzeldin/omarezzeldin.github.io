...
<h:panelGrid columns="3" align="center" border="0">
    ...
    <a4j:jsFunction name="tree_search" id="tree_search" action="#{treeDivBean.searchTreeFromSpecificChar}" reRender="treeDivList,cancelsearchpanel,noResult,okPanel" oncomplete="focusOnSearchResult();"  />
        </h:panelGroup>
    </t:panelGrid>
</h:panelGrid>
