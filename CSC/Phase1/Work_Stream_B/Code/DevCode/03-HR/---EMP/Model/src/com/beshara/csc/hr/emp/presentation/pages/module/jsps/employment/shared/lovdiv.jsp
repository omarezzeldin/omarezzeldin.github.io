...
<t:panelGrid  align="center">
    <t:panelGroup>
        <t:outputText value="#{pageBeanName.lovBaseBean.errorMsgValue}" forceId="true" id="errorMessag_lov123" styleClass="errMsgNoHeight" />
    </t:panelGroup>
...
<t:panelGrid columns="4" id="lov_searchPanel" align="center" dir="#{shared_util.pageDirection}" forceId="true" width="60%" >
     ...
     <t:panelGroup>
        <t:commandButton type="button" id="lov_search_btn_code_string" forceId="true" onclick="if(validateCodeNameSrchParamter('lov_searchRadioBtn','lov_searchText','true','errorMessag_lov123')){ lov_search();}" styleClass="ManyToManySearchButton" />
