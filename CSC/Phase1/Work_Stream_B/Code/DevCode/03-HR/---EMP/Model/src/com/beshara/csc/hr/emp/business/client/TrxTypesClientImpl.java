...
import com.beshara.csc.hr.emp.business.deploy.EmployeeHchildCatsSession;
import com.beshara.csc.hr.emp.business.deploy.TrxTypesSession;
 ...
 * @since 03/09/2007
 */
public class TrxTypesClientImpl extends BaseClientImpl3 implements ITrxTypesClient {


    public TrxTypesClientImpl() {
        super();
    }

    protected Class<? extends BasicSession> getSessionInterface() {
        return TrxTypesSession.class;
    }

    protected TrxTypesSession SESSION() {
        return (TrxTypesSession)super.SESSION();
    }
}
