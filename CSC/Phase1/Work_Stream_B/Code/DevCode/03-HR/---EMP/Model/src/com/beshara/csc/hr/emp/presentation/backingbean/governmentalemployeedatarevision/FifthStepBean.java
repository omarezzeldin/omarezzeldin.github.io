...
public class FifthStepBean extends LookupMaintainBaseBean{
    ...
    public FifthStepBean() {
        setCustomDiv1("govempBenifitsAndRewards");
    ...
    public String init(){
        ...
        try {
            ...
            ////////////// check GET DATA FROM LOCAL CLIENT OR FROM SPECIFIC MINISTRY CLIENT 
             if(maintainBean.getMinistryCode() != null){
            degreeWhenHired =SalClientFactory.getSalEmpSalaryElementsClient(maintainBean.getMinistryCode()).getEmployeeDegreeWhenHired(civilID);
             }
            else
            {
    ...
    private Double getTotalSalEmpSalaryElementsValue(ISalEmpMonSearchCriteriaDTO searchDTO) {
        ...
        try {
            ////////////// check GET DATA FROM LOCAL CLIENT OR FROM SPECIFIC MINISTRY CLIENT 
             if(maintainBean.getMinistryCode() != null){
             salEmpSalaryElementsDTOList = SalClientFactory.getSalEmpSalaryElementsClient(maintainBean.getMinistryCode()).getEmployeeElementsByTypeInPeriode(searchDTO);
             }
             else
             {
            salEmpSalaryElementsDTOList = SalClientFactory.getSalEmpSalaryElementsClient().getEmployeeElementsByTypeInPeriode(searchDTO);
             }
        } catch (Throwable e) {
            e.printStackTrace();
        }
    ...
    public void showBenefitsRewardsDiv(){
        try {
            ...
            ////////////// check GET DATA FROM LOCAL CLIENT OR FROM SPECIFIC MINISTRY CLIENT 
             if(maintainBean.getMinistryCode() != null){
             benifitsAndRewardsList = SalClientFactory.getSalEmpSalaryElementsClient(maintainBean.getMinistryCode()).getEmpBenefitsByCivil(GovEmpMaintainBean.getEmpCivilId());
             }
             else
             {
                 benifitsAndRewardsList = SalClientFactory.getSalEmpSalaryElementsClient().getEmpBenefitsByCivil(GovEmpMaintainBean.getEmpCivilId());
             }
    ...
    public void salElementTypeChanged(){
        ...
        try {
            ...
            {
                if(maintainBean.getMinistryCode() != null){
                benifitsAndRewardsList = SalClientFactory.getSalEmpSalaryElementsClient(maintainBean.getMinistryCode()).getEmpRewardsByCivil(GovEmpMaintainBean.getEmpCivilId());
                }
                else
                {
                benifitsAndRewardsList = SalClientFactory.getSalEmpSalaryElementsClient().getEmpRewardsByCivil(GovEmpMaintainBean.getEmpCivilId());
                }
            }
        } catch (SharedApplicationException e) {
            e.printStackTrace();
