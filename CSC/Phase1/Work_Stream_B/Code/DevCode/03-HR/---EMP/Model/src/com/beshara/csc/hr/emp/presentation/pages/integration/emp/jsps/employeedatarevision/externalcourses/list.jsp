...
<f:view locale="#{shared_util.locale}">
    <f:loadBundle basename="com.beshara.csc.hr.emp.integration.presentation.resources.integration"
                  var="resourcesBundle"/>
    <h:form id="myForm" binding="#{govExternalCoursesBean.frm}">
        <t:aliasBean alias="#{pageBeanName}" value="#{govExternalCoursesBean}">
            <t:aliasBean alias="#{detailBeanName}" value="#{govExternalCoursesBean}">
                ...
                <t:saveState value="#{govExternalCoursesBean.externalCoursesLst}"/>
                <tiles:insert definition="externalCoursesList.page" flush="false">
