...
<f:loadBundle basename="com.beshara.jsfbase.csc.msgresources.globalexceptions" var="globalexceptions"/>
    <h:form id="myForm" binding="#{experienceMinListBean.frm}">
        <t:aliasBean alias="#{pageBeanName}" value="#{experienceMinListBean}" id="alias1">
            <tiles:insert definition="experienceMinList.page" flush="false">
