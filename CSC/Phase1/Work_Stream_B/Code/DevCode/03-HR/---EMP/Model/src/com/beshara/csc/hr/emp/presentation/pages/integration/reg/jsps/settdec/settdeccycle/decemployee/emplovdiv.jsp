...
<t:panelGroup>
    ...
    <a4j:support action="#{detailBeanName.empListOfValues.hideLovDiv}" event="onclick"  oncomplete="hideLookUpDiv(window.blocker,window.lovEmp);if(typeof(setFocusAfterCloseEmpLovDiv)!='undefined'){setFocusAfterCloseEmpLovDiv()};" reRender="divSearch"/>
</t:panelGroup>
