...
<f:view locale="#{shared_util.locale}">
    <h:form enctype="multipart/form-data" id="myForm" binding="#{addDocAttachmentsIntegrationBean.frm}">
        ...
        <t:aliasBean alias="#{pageBeanName}" value="#{addDocAttachmentsIntegrationBean}">
            <tiles:insert flush="false" definition="addDocAttachmentsIntegration.page">
                ...
                <t:saveState value="#{pageBeanName.notes}"/>
            </tiles:insert>
        </t:aliasBean>
