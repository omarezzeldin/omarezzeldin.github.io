...
<t:panelGroup>
    <t:commandButton forceId="true" id="lovDivOkTBtn" binding="#{pageBeanName.lovBaseBean.okBtnLovDiv}" disabled="true" value="#{globalResources.ok}" type="button" styleClass="cssButtonSmall" onclick="clearOutputText('errorMessag_lov'); return searchLovFunName();">
      <a4j:jsFunction id="lovDivOkTBtnJSFFID" name="searchLovFunName" action="#{pageBeanName.returnSearchLovDiv}"  reRender="wholediv,#{pageBeanName.lovBaseBean.renderedDropDown}"/>
      <%-- oncomplete="#{pageBeanName.lovBaseBean.onCompleteList}"--%>
      <%--action="#{pageBeanName.lovBaseBean.closeLovDiv}"--%>
    </t:commandButton>
</t:panelGroup>
...
<t:panelGroup>
    ...
    <a4j:support action="#{pageBeanName.hideLovDiv}" event="onclick" reRender="wholediv"/>
