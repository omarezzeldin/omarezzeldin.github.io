...
<t:panelGroup id="dataT_data_panel" forceId="true" styleClass="dataT-With-3-row-filter">
    <t:dataTable id="dataT_data" var="list"
        ...
        <t:column id="code_column" width="50">
            <f:facet name="header">
                <t:commandLink id="sort_citizensResidentsDTO-code-key" forceId="true" styleClass="headerLink"
                    ...
                    <t:graphicImage value="#{(pageBeanName.sortAscending&&pageBeanName.fullColumnName=='citizensResidentsDTO-code-key') ? '/app/media/images/ascending-arrow.gif' : ''}"
                                    border="0"/>
                    <t:graphicImage value="#{(!pageBeanName.sortAscending&&pageBeanName.fullColumnName=='citizensResidentsDTO-code-key') ? '/app/media/images/descending-arrow.gif' :''}"
                                    border="0"/>
                </t:commandLink>
            </f:facet>
   ...
   <t:column id="transReqDate_column" width="50">
             <f:facet name="header">
                <t:commandLink id="sort_transReqDate" forceId="true" styleClass="headerLink"
                    ...
                    <f:param name="bsnSortingColumnName" value="HR_EMP_CANDIDATES.TRANS_REQ_DATE"/>
        ...
        <t:column id="lastPersonQualification_column" width="300">
         ...
         <t:column id="hasRevision_column" width="130" rendered="#{pageBeanName.approveBtnShow}">
         <f:facet name="header">
                <t:commandLink id="sort_hasRevision" forceId="true" styleClass="headerLink"
                               value="#{resourcesBundle.orderType}" actionListener="#{pageBeanName.sortDataTable}">
                    <f:param name="bsnSortingColumnName" value="hasRevision"/>
                    <t:graphicImage value="#{(pageBeanName.sortAscending&&pageBeanName.fullColumnName=='hasRevision') ? '/app/media/images/ascending-arrow.gif' : ''}"
                                    border="0"/>
                    <t:graphicImage value="#{(!pageBeanName.sortAscending&&pageBeanName.fullColumnName=='hasRevision') ? '/app/media/images/descending-arrow.gif' :''}"
                                    border="0"/>
                </t:commandLink>
            </f:facet>
            <h:outputText id="content_hasRevision" value="#{resourcesBundle.order_viewed}" rendered="#{list.hasRevision == true}"/>
            <h:outputText id="content_hasnotRevision" value="#{resourcesBundle.order_not_viewed}" rendered="#{list.hasRevision == false}"/>
        </t:column>
        ...
        <t:column id="userNameValue_column" width="150" rendered="#{pageBeanName.approveBtnShow}" >
            ...
            <h:outputText id="content_userNameValue" value="#{list.userNameValue}"/>
        </t:column>
