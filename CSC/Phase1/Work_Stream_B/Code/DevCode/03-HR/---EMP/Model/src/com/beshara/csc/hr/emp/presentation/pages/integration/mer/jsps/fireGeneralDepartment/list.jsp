...
<f:view locale="#{shared_util.locale}">
    ...
    <h:form id="myForm" binding="#{fireGeneralDepartmentBean.frm}">
   <%--<t:messages showDetail="true" id="msgdetId" forceId="true"/>--%>
        <t:aliasBean alias="#{pageBeanName}" value="#{fireGeneralDepartmentBean}">
            <t:aliasBean alias="#{searchMinistryHelper}" value="#{fireGeneralDepartmentBean.searchMinistryHelper}">
                <tiles:insert definition="fireGeneralDepartmentFile.page" flush="false"/>
                    ...
                    <t:saveState value="#{pageBeanName.fileTypeRadio}"/>
                    <t:saveState value="#{pageBeanName.graditionFileTypeRadio}"/>
                    <t:saveState value="#{pageBeanName.showGraditionFileTypeRadio}"/>
