    ...
    <h:outputText id="clientErrorMessageEdit" styleClass="errMsg" />
     ...
     <h:panelGrid columns="1" rendered="#{pageBeanName.showEdit}" width="100%">
        <h:panelGrid columns="2" border="0" rowClasses="row02,row01" width="100%" cellpadding="3" cellspacing="0">
            ...
            <h:panelGroup>
                <t:inputText id="edit_first_inputTxt" onblur="if(isVisibleComponent('lookupEditDiv'))document.getElementById('edit_enName_inputTxt').focus();" onchange="trimBorders(edit_first_inputTxt);"  value="#{pageBeanName.selectedPageDTO.name}" styleClass="textboxlarge" maxlength="#{pageBeanName.nameMaxLength}" forceId="true"/>
                <h:outputText value="*" styleClass="mandatoryAsterisk"/>
            </h:panelGroup> 
            
             <h:outputText value="#{globalResources.englishName}" styleClass="lable01" />
            <h:panelGroup>
                <t:inputText id="edit_enName_inputTxt" onblur="if(isVisibleComponent('lookupEditDiv'))document.getElementById('SaveButtonEdit').focus();" onchange="trimBorders(edit_enName_inputTxt);"  value="#{pageBeanName.selectedPageDTO.engName}" styleClass="textboxlarge" maxlength="#{pageBeanName.nameMaxLength}" forceId="true" dir="ltr"/>                
            </h:panelGroup>    
        </h:panelGrid>
