...
<t:panelGrid columns="6" rowClasses="row01,row02" width="100%" cellpadding="3" cellspacing="0" border="0" rendered="true">
    ...
    <%--- Start of Row 2--%>
       ...
       <t:panelGroup colspan="3" id="civilPnl" forceId="true">
            <t:inputText  styleClass="textboxsmall2" value="#{pageBeanName.empDecisionsDTOSlelected.employeesDTO.citizensResidentsDTO.civilId}" maxlength="12" forceId="true" 
                          id="civilIdInTxt" converter="javax.faces.Long" tabindex="1" 
                          disabled="true"/>
               ...
               <f:verbatim>&nbsp;&nbsp; </f:verbatim>
                ...
                <a4j:commandButton type="button" value="#{globalResources.SearchButton}" styleClass="cssButtonSmallest"
                 ...
                 <t:commandButton id="searchemp" forceId="true" value="#{globalResources.Available}" styleClass="cssButtonSmall" 
                                disabled="#{pageBeanName.showOnly}" rendered="#{!delegationDecisionEmployeesMaintainBean.civilExist}"
                ...
                <a4j:jsFunction name="resetEmpDataFn" action="#{delegationDecisionEmployeesMaintainBean.resetEmpDataIfNoAddedElms}" 
                           reRender="showResetEmpDataAlertDiv,denar_number1,fels_number1,paging_panel,all_dataT_data_panel,detail_sal_elm_guide,EmpNamePnl,civilPnl,divMsg"
                            oncomplete="showResetEmpDataAlertDivFn();"/>
      ...
      <t:panelGroup id="EmpNamePnl" forceId="true" colspan="1" >
                <t:inputText forceId="true" disabled="true" id="EmpName" styleClass="textboxlarge" style="width: 200px;" 
                    value="#{pageBeanName.empDecisionsDTOSlelected.employeesDTO.citizensResidentsDTO.fullName}" />
       </t:panelGroup>
       ...
       <%--<t:outputText forceId="true" id="merDurationFrom" styleClass="divtext" value="#{regResources.merDurationFrom}"/>--%>
        ...
        <t:outputText forceId="true" id="codeText" styleClass="divtext"
                                  value="#{regResources.merSection}" rendered="#{!delegationDecisionMaintainBean.showOnly}"/>
        <t:panelGroup colspan="3" id="detail_sal_elm_guide" forceId="true"  rendered="#{!delegationDecisionMaintainBean.showOnly}">
           <t:inputText id="dtl_sal_elm_guide_code" forceId="true" value="#{pageBeanName.selectedElementGuideCode}"  
                        disabled="#{delegationDecisionMaintainBean.showOnly}" tabindex="4" styleClass="textboxsmall"
                        onkeypress="handleEnterKey(event)" onkeyup="enabelIntegerOnly(this);"  />
            <%--onblur="validate_onchangeElmguideCode();" --%>
            <a4j:jsFunction actionListener="#{pageBeanName.searchElmguideForSpecificTypes}" name="onchangeElmguideCode"
                             oncomplete="changeVisibilityMsg();"
                             reRender="btnPnl,divMsg,errorcodeMsgPanel,dtl_sal_elm_guide,errorMsg,scriptPanel,scriptGenerator,OperationBar,paging_panel" />
            <f:verbatim>&nbsp;</f:verbatim>
            <t:inputText forceId="true" styleClass="textboxmedium" id="dtl_sal_elm_guide" style="width: 180px;"
                         readonly="true" disabled="true" value="#{pageBeanName.selectedElementGuideName}"/>
            <f:verbatim>&nbsp;</f:verbatim>            
            ...
            <a4j:commandButton value="..." styleClass="cssButtonSmaller" onclick="openTreeDiv();"             
                       reRender="errorcode,pagedTreeDiv,scriptGenerator" id="selectSalGuide" />
            <h:outputText value="*" styleClass="mandatoryAsterisk" />
            <a4j:jsFunction  action="#{pageBeanName.openTreeDiv}" name="openTreeDiv"
                     oncomplete="changeVisibilityMsg();"
            ...
            <t:outputText forceId="true" id="errorMsg" value="#{resourcesBundle.MessageForWrongElmguideCode}" styleClass="errMsg" rendered="#{pageBeanName.showErrorMsg1}" />            
            <t:outputText id="errorElmGuideFoundMessage" forceId="true" styleClass="errMsg" value="#{pageBeanName.elmGuideExist}"/>
            </t:panelGroup>
         ...
         <t:panelGroup forceId="true" id="btnPnl" colspan="2"  rendered="#{!delegationDecisionMaintainBean.showOnly}">  
            ...
            <t:selectOneMenu forceId="true" id="signValueComboId" styleClass="textbox" style="width:40px;"
                             value="#{pageBeanName.signal}" rendered="#{(pageBeanName.decType == 2)}" >
                <f:selectItem itemLabel="+" itemValue="+"/>
                <f:selectItem itemLabel="-" itemValue="-"/>
            </t:selectOneMenu>
            <f:verbatim rendered="#{(pageBeanName.decType == 2)}">&nbsp; </f:verbatim>
            <t:inputText id="fels_number1" tabindex="6" onkeypress="FireButtonClickOldStyle(event,'ava');" forceId="true"  value="#{pageBeanName.felsValue}"  onkeyup="disableCharacters(this);" maxlength="3"  styleClass="textbox" style="width:30px;" />
            <f:verbatim>&nbsp; </f:verbatim>
            <t:inputText id="denar_number1" tabindex="5" onkeypress="FireButtonClickOldStyle(event,'ava');" forceId="true" value="#{pageBeanName.dinarValue}" onkeyup="disableCharacters(this);" maxlength="8"  styleClass="textbox"   style=" width: 50px;  margin-right: 1px; margin-left: 1px;" />
                 ...
                 <%--<f:verbatim>&nbsp;&nbsp; </f:verbatim>--%>
            <t:commandButton tabindex="7" id="ava" forceId="true" value="#{globalResources.addButton}" styleClass="cssButtonSmaller" 
                                   action="#{pageBeanName.addSalElmentGuide}" disabled="#{empty pageBeanName.selectedElementGuideName}"  onclick="resetErrorMsgs();return (validatemyForm('elmguideCode') );" />
      ...
      <h:outputText value="#{regResources.emp_total_value}"/>    
      <t:panelGroup id="totalValuePnl" forceId="true" colspan="1">
        <t:inputText forceId="true" disabled="true" id="total_value" styleClass="textbox" value="#{pageBeanName.totalValue}" />
      </t:panelGroup>
        <!-- ************************************************************************************************ -->
</t:panelGrid>
...
<t:inputHidden forceId="true" id="showResetEmpDataAlertDiv" value="#{pageBeanName.showResetEmpDataAlertDiv}" />
