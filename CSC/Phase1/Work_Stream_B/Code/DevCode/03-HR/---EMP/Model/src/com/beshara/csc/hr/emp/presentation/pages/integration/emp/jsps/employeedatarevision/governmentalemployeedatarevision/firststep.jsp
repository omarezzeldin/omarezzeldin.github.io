        ...
        <t:aliasBean alias="#{pageBeanName}" value="#{govEmpFirstStepBean}">
           <t:aliasBean alias="#{detailBeanName}" value="#{govEmpMaintainBean}">
            ...
            <t:saveState value="#{detailBeanName.realCivilId}"/>
             ...
             <t:saveState value="#{pageBeanName.jobTechName}"/>
            ...
            <tiles:insert flush="false" definition="govempfirststep.page">
