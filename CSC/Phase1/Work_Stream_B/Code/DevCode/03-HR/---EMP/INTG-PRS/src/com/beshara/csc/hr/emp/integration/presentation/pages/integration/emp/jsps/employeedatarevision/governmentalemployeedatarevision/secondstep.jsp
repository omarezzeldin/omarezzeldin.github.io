...
<f:view locale="#{shared_util.locale}">
    ...
    <h:form id="myForm" binding="#{govEmpSecondStepBean.frm}">
        <f:loadBundle basename="com.beshara.csc.hr.emp.integration.presentation.resources.integration"
                      var="resourcesBundle"/>
        <t:aliasBean alias="#{pageBeanName}" value="#{govEmpSecondStepBean}">
            <t:aliasBean alias="#{detailBeanName}" value="#{govEmpMaintainBean}">
                ...
                <t:saveState value="#{pageBeanName.movMovingRequestsDTO}"/>
                <t:saveState value="#{pageBeanName.personBankAccountsDTO}"/>
                ...
                <t:saveState value="#{pageBeanName.degreeName}"/>
                <t:saveState value="#{pageBeanName.endJobDate}"/>
                <t:saveState value="#{pageBeanName.firstHireDate}"/>
                <t:saveState value="#{pageBeanName.jobGroup}"/>
                <t:saveState value="#{pageBeanName.jobAssignDate}"/>
                <t:saveState value="#{pageBeanName.techJobAssignDate}"/>
                <t:saveState value="#{pageBeanName.hireDegree}"/>
                <t:saveState value="#{pageBeanName.totalReward}"/>
                <t:saveState value="#{pageBeanName.showSubWCenter}"/>
                <t:saveState value="#{pageBeanName.subWCenterCode}"/>
                <t:saveState value="#{pageBeanName.subWCenterName}"/>
                ...
                <tiles:insert flush="false" definition="govempsecondstep.page">
