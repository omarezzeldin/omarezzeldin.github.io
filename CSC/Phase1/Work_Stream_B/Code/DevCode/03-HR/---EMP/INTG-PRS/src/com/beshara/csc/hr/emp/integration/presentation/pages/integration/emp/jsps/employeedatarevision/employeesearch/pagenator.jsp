...
<t:panelGroup forceId="true" id="paging_panel">
        <t:outputText dir="ltr" forceId="true" id="listSize" style="width:100%"
                      ...
                      value="#{globalResources.noOfRecords} : #{pageBeanName.usingPaging ? pageBeanName.pagingBean.totalListSize : pageBeanName.availableListSize}"/>
        <h:panelGrid id="panelGrd_scroller" columns="1" dir="#{shared_util.pageDirection}" styleClass="scroller" width="300" rendered="#{pageBeanName.availableListSize > shared_util.noOfTableRows}" >
