    ...
    <htm:table width="100%" border="0" cellspacing="0" cellpadding="2">
        <htm:tr>
            ...
            <htm:td style="background: none repeat scroll 0% 0% white;">
                <t:outputLabel value="#{resourcesBundle.external_Courses}" styleClass="lable01"/>
            </htm:td>
        </htm:tr>
...
<t:panelGroup id="firstTablePG" forceId="true" styleClass="dataT-With-1-row-filter" style="margin-left: 7px;">
    <t:dataTable id="dataT_firstTable" var="list" value="#{pageBeanName.externalCoursesLst}" preserveDataModel="false"
        ...
        <t:column id="planCode_column" sortable="false" width="10%">
            <f:facet name="header">
                <t:outputText value="#{resourcesBundle.planCode_external_course}" styleClass="headerLink"/>
            </f:facet>
            <h:outputText id="planCode_content" value="#{list.planCode}"/>
        </t:column>
        <t:column id="missionCode_column" sortable="false" width="10%">
            <f:facet name="header">
                <t:outputText value="#{resourcesBundle.missionCode_external_course}" styleClass="headerLink"/>
            </f:facet>
        ...
        <t:column id="cntryName_column" sortable="false" width="10%">
            <f:facet name="header">
                <t:outputText value="#{resourcesBundle.cntryName_external_course}" styleClass="headerLink"/>
            </f:facet>
    ...
    <t:panelGrid columns="1" rendered="#{pageBeanName.externalCoursesLstSize == 0}" align="center">
