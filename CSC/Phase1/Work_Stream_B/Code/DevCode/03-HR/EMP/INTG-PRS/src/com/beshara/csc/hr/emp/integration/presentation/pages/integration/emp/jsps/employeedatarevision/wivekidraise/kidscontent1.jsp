...
<t:panelGrid columnClasses="colu1,colu2" columns="4" width="100%"  rowClasses="row01,row02" cellpadding="3" cellspacing="0" forceId="true" id="cnt1Panel">
    ...
    <t:inputText forceId="true"  id="empName" styleClass="textboxmedium"  value="#{govEmpMaintainBean.empName}" disabled="true"/>
            ...
            <h:outputText value="#{resourcesBundle.mer_mother_name}" styleClass="divtext"/>
                    <t:panelGroup id="MotherNamePanel" forceId="true">
                    <t:selectOneMenu forceId="true" id="motherName" styleClass="textboxmedium" 
                        value="#{pageBeanName.selMother}" onblur="setFousAtNextAfterComboItem();" rendered="#{!merRaiseMaintainBean.femaleGender}">
        
                    <f:selectItem itemLabel="#{resourcesBundle.all}" itemValue="#{pageBeanName.virtualConstValue}" />
                    <t:selectItems value="#{pageBeanName.empWives}" itemLabel="#{empWives.kwtCitizensResidentsDTO.firstName} #{empWives.kwtCitizensResidentsDTO.secondName}" 
                    itemValue="#{empWives.kwtCitizensResidentsDTO.code.key}" var="empWives"/>
                    
                    <a4j:support actionListener="#{pageBeanName.getKidsByMother}" event="onchange"
                                 reRender="mainDataEmpPanel,scriptGenerator,displayBtnPanel, dataT_data_panel, OperationBar ,paging_panel"/>
                    </t:selectOneMenu>
                    <t:selectOneMenu forceId="true" id="motherName1" styleClass="textboxmedium" disabled="true"
                        value="#{pageBeanName.selMother}" onblur="setFousAtNextAfterComboItem();" rendered="#{merRaiseMaintainBean.femaleGender}">
                    ...
                    <%--t:commandButton id="issue_soc_dec_btn" forceId="true" value="#{resourcesBundle.issue_soc_dec_btn}" styleClass="cssButtonSmall" rendered="#{merRaiseMaintainBean.femaleGender}"
                                     action="#{pageBeanName.issueFemaleDecision}" disabled="#{detailBeanName.listSize == 0}"/--%>
...
<t:panelGrid columns="4" border="0" width="100%"  forceId="true" id="mainDataEmpPanel" rowClasses="row01,row02" cellpadding="0" cellspacing="0" >
                    ...
                    <t:panelGroup>
                        ...
                        <t:panelGroup>
                            ...
                            reRender="mainDataEmpPanel,scriptGenerator,displayBtnPanel, dataT_data_panel, OperationBar ,paging_panel" oncomplete="setFocusFirstElem();"/>
                        </t:panelGroup>
                        <a4j:commandButton id="resetData_btn_id"  value="#{globalResources.reSetButton}" oncomplete="setFocusFirstElem();" 
                                            ...
                                            onkeydown="onKeyDownFirstElement(event,'sort_code',null);"
                                            reRender="mainDataEmpPanel,scriptGenerator, dataT_data_panel, OperationBar ,paging_panel,scriptPanelID"/>
                        <f:verbatim>&nbsp;</f:verbatim>
