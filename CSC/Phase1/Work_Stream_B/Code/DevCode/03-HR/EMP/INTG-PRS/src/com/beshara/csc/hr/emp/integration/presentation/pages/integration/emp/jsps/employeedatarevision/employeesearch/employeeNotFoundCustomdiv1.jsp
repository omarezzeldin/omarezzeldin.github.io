...
<t:panelGrid columns="1" width="100%" align="center">
     <t:panelGroup forceId="true" id="divcustomDiv1"  style="width:600px;" >
           <t:panelGrid columns="2" align="center">
            <t:outputLabel id="rbfreezMsg"   styleClass="msg warning"/>
              <t:outputText value="#{regResources.contenue_div_search}" styleClass="msg" />
           </t:panelGrid>
    </t:panelGroup>
    <t:panelGrid columns="2" align="center">
        <%-- updated by Ashraf Gaber 24/2/09 to handel keyboard shortcuts --%>
        <t:commandButton forceId="true" id="OkButtondivcustomDiv1" onblur="if(isVisibleComponent('customDiv1'))document.getElementById('CancelButtondivcustomDiv1').focus();" styleClass="cssButtonSmall" value="#{globalResources.ok}" action="#{detailBeanName.searchAvailable}" />
