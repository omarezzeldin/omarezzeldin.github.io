...
<t:panelGrid border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <t:panelGroup forceId="true" id="civil_div_dataT_data_panel" styleClass="lovDivScroll5">
        ...
        <t:dataTable id="civil_div_dataT_data" var="list" value="#{pageBeanName.empListOfValues.usingPaging ? govEmpFirstStepBean.empListOfValues.pagingBean.myPagedDataModel : govEmpFirstStepBean.empListOfValues.myTableData}" rowStyleClass="#{ pageBeanName.empListOfValues.selected ? 'standardTable_RowHighlighted' : null}"
...
<t:panelGrid columns="2" align="center">
 <a4j:commandButton id="civil_div_ok" value="#{globalResources.ok}" action="#{pageBeanName.empListOfValues.closeLovDiv}" styleClass="cssButtonSmall" oncomplete="hideLookUpDiv(window.blocker,window.lovEmp);foucsFirstElementOnListPage();" reRender="#{pageBeanName.empListOfValues.renderedDropDown}" binding="#{pageBeanName.empListOfValues.okCommandButton}" disabled="#{empty pageBeanName.empListOfValues.selectedDTOS}" />
 <t:commandButton onblur="settingFoucsAtEmpLovDiv();" forceId="true" id="backButtonEmpLovDiv" type="button" value="#{globalResources.back}" onclick="hideLookUpDiv(window.blocker,window.lovEmp);foucsFirstElementOnListPage();" styleClass="cssButtonSmall"/>
</t:panelGrid>
</t:panelGroup>
