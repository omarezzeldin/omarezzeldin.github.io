...
@XmlRootElement(name = "MoiHeader")
public class MoiHeader {

    @XmlElementRef(name = "Entity", type = JAXBElement.class)
    ...
    @XmlElementRef(name = "Requestor", type = JAXBElement.class)
    ...
    public void setRequestor(JAXBElement<String> value) {
        this.requestor = ((JAXBElement<String> ) value);
    }
