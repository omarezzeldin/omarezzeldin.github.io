...
public class SixthStepBean extends LookupMaintainBaseBean {
    ...
    public String init() {
        ...
        try {
            ...
            periodicalVacBalance =VacClientFactory.getVacEmployeeBalancesClient(maintainBean.getMinistryCode()).getPeriodicVacBalanceByCivilId(civilID);
            }
            else
            {
            periodicalVacBalance =VacClientFactory.getVacEmployeeBalancesClient().getPeriodicVacBalanceByCivilId(civilID);
            }
        } catch (Throwable e) {
            e.printStackTrace();
        }
