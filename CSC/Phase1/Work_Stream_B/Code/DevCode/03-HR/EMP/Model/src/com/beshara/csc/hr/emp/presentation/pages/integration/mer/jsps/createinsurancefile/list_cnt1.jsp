    ...
    <%--<t:outputText id="requestcreator-content_ministrytype" value="#{integrationBundle.type}"  styleClass="lable01 nowrap_txt" />--%>
        ...
        <t:selectOneMenu forceId="true"
            ...
            <a4j:jsFunction name="changeCategory" actionListener="#{pageBeanName.clearMinData}"
                            reRender="ministryNamePanelId,catPanelID,scriptGeneratorPanel,OperationBar,searchPanelId,radioPanel2,errorCodePanelId2,searchBtn,createInsurFile" 
    ...
    <t:panelGroup forceId="true" id="searchPanelId">
            ...
            <t:inputText forceId="true" id="minFilterationId" styleClass="filteration_input_text"
                ...
                <a4j:jsFunction name="changeMinistry" actionListener="#{pageBeanName.changeMinistry}"
                                reRender="radioPanel2,ministryNamePanelId, OperationBar,ministryName,errorCodePanelId2,searchBtn,createInsurFile"/>
            </t:inputText>
        ...
        <t:panelGroup forceId = "true" id="ministryNamePanelId">
            ...
            <a4j:commandButton id="searchMinistryBtn" value="..." action="#{pageBeanName.openSearchMinistryDiv}" styleClass="cssButtonSmall" 
                ...
                reRender="searchMinistryDiv,searchBtn,createInsurFile,OperationBar" 
    ...
    <t:panelGroup forceId="true" id="radioPanel"  dir="#{shared_util.pageDirection}" colspan="4">
        <t:panelGrid align="center">
            <t:selectOneRadio  forceId="true" id="radioBtn" value="#{pageBeanName.fileTypeRadio}">
                <f:selectItem   itemLabel="#{integrationBundle2.joinFile_title}" itemValue="0"/>
                <f:selectItem itemLabel="#{integrationBundle2.dedFile_title}" itemValue="1"/>
                <f:selectItem itemLabel="#{integrationBundle2.gradationFile_title}" itemValue="2"/>
                <a4j:support event="onclick" actionListener="#{pageBeanName.radioButtonChanged}" reRender="searchBtn,createInsurFile,radioPanel2"/>
            </t:selectOneRadio>     
        </t:panelGrid>
    </t:panelGroup>
    <t:panelGroup forceId="true" id="radioPanel2"  dir="#{shared_util.pageDirection}" colspan="4">
        <t:panelGrid align="center" forceId="true" id="graditionFileTypeRadio_pnl" rendered="#{pageBeanName.showGraditionFileTypeRadio}">
            <t:selectOneRadio  forceId="true" id="graditionFileTypeRadio_radioBtn" value="#{pageBeanName.graditionFileTypeRadio}">
                <f:selectItem itemLabel="#{integrationBundle2.diwan_amiri_lbl}" itemValue="1"/>
                <f:selectItem itemLabel="#{integrationBundle2.diwan_wally_elahd_lbl}" itemValue="2"/>
                <%--<a4j:support event="onclick" actionListener="#{pageBeanName.radioButtonChanged}" reRender="searchBtn,createInsurFile,radioPanel"/>--%>
            </t:selectOneRadio>     
        </t:panelGrid>
    </t:panelGroup>
...
<t:panelGroup style="display:block;text-align: center;">
    ...
    <t:commandButton id="createInsurFile" forceId="true" value="#{pageBeanName.fileTypeRadio=='0'? integrationBundle2.createJointInsurFile : pageBeanName.fileTypeRadio=='1' ? integrationBundle2.createDedInsurFile : integrationBundle2.createGradationFile }"  
        disabled="#{pageBeanName.selectedMiniName==null || pageBeanName.selectedMiniName==''}" 
        action="#{pageBeanName.createInsuranceFile}" styleClass="cssButtonSmall" onclick="clearMsgs();if(validatemyForm()){block();return true; }else {return false;}"/>
    <%-- || ( pageBeanName.fileTypeRadio=='0' &&  (pageBeanName.selectedMiniId == 10   || pageBeanName.selectedMiniId == 1 ))--%>
    <t:commandButton id="searchBtn" forceId="true" value="#{pageBeanName.fileTypeRadio=='0'? integrationBundle2.viewJointInsurFile : pageBeanName.fileTypeRadio=='1' ? integrationBundle2.viewDedInsurFile : integrationBundle2.viewGradationFile}"  
        disabled="#{pageBeanName.selectedMiniName==null || pageBeanName.selectedMiniName==''}" styleClass="cssButtonSmall" action="#{pageBeanName.viewFileDetails}"  onclick="clearMsgs();return validatemyForm();"/>
