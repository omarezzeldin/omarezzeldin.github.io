...
<f:view locale="#{shared_util.locale}">
    ...
    <t:aliasBean alias="#{pageBeanName}" value="#{reviewMinListBean}">
    <t:aliasBean alias="#{jSearchBeanName}" value="#{reviewMinListBean.jobFilter}">
        <h:form id="myForm" binding="#{pageBeanName.frm}">
            <tiles:insert definition="reviewMinList.page" flush="false">
                <t:saveState value="#{reviewMinListBean.pageDTO}"/>
                <t:saveState value="#{reviewMinListBean.bgtTypesDTO}"/>
