...
public class ReviewListBean extends LookUpBaseBean {
    ...
    public static final String METHOD_NAME_ADD_SELECTED_JOBS = "reviewMinListBean.jobForCrs";
    ...
    private final int ORG_CAT_CODE_ATT_BGT = 
        3; //الهيئات ذات الميزانيات الملحقة
    private final int ORG_CAT_CODE_SPR_BGT = 
        4; //المؤسسات ذات الميزانية المستقلة
    ...
    public ReviewListBean() {
        ...
        if (getLovBaseBean().isUsingPaging()) {
            getLovBaseBean().generatePagingRequestDTO("reviewMinListBean", 
                                                      "initMainDataBean");
        } else {
...
//        while(jobList.size() < 2) jobList.add(0);
    ...
    public void showJobDiv() {
        ...
        setRenderLovDiv(true);
         ...
         public void checkValidFilMinNo(ActionEvent ae) {
             ...
             if (getPageDTO() != null && 
                 ((IEmpCandidatesDTO)getPageDTO()).getMinistryFileNo() != null && 
    ...
    public void budgetTypeController(IBasicDTO budgetTypeDTO, 
                                     String _stageId) {
        ...
        if (checkForStageId(stageId)) {
            if (dto.getCode() != null) {
                IBgtTypesEntityKey entityKey = 
                    (IBgtTypesEntityKey)budgetTypeDTO.getCode();
    ...
    public void salaryDataSectionController(boolean hasExperience, 
                                            String _stageId) {

        Long stageId = Long.parseLong(_stageId);
        if (( stageId.equals(IEMPConstant.HIRE_STAGE_JOB_NAME_ACCEPTRD) &&  ! hasExperience) || ( stageId.equals(IEMPConstant.HIRE_STAGE_FIN_DEGREE_REQUIRED) &&  hasExperience)) {
    ...
    public void calculateNextDateOfRaise() {
        ...
        System.out.println("Next Raise of Date>>>>>>>" + 
                           ((IEmpCandidatesDTO)getPageDTO()).getDateOfNextRaise());
    }
...
//                ((EmpCandidatesDTO)getPageDTO()).setJobKey(jobKey);
    ...
    public boolean checkIsCandidatePersonValid() {
        boolean valid = true;
        IEmployeesCMTClient employeesCMTClient = 
            EmpClientFactory.getEmployeesCMTClient();
        ...
        KwtCitizensResidentsEntityKey kwtEntityKey = 
            (KwtCitizensResidentsEntityKey)kwtCitizensResidentsDTO.getCode();
...
//            break;
    ...
    public void showListOfValuesDiv() {
        ...
        getLovBaseBean().setMyTableData(new ArrayList());
        getLovBaseBean().getPagingBean().updateMyPadgedDataModel(new PagingResponseDTO(new ArrayList(), 
                                                                                       0));
        ...
        getLovBaseBean().setReturnMethodName("reviewMinListBean.wrkCenterValue");
        getLovBaseBean().setSearchMethod("reviewMinListBean.searchWrkCenters");
        ...
        getLovBaseBean().setCancelSearchMethod("reviewMinListBean.cancelSearchLovDiv");
    }
    ...
    public void showListOfValuesDivForJob() {
        ...
        if (getLovBaseBean().isUsingPaging()) {
            getLovBaseBean().generatePagingRequestDTO("reviewMinListBean", 
                                                      "getJobListForMinWithPaging");

        }

        getLovBaseBean().getOkCommandButton().setReRender("WorkCenter_Panel,suggestedJobPanelGrp,selected_job_panel_grp");
        getLovBaseBean().setReturnMethodName("reviewMinListBean.suggestedJobValue");
        getLovBaseBean().setSearchMethod("reviewMinListBean.searchJob");
        getLovBaseBean().setSelectedDTOS(new ArrayList<IBasicDTO>());
        getLovBaseBean().setSelectedRadio("");
        getLovBaseBean().setSearchTyp("0");
        getLovBaseBean().setSearchQuery("");
        getLovBaseBean().setSearchMode(false);
        getLovBaseBean().setCancelSearchMethod("reviewMinListBean.cancelSearchLovDivForJob");
    }
    ...
    public void showListOfValuesDivForJobCrs() {
        ...
        getLovBaseBean().getOkCommandButton().setReRender("WorkCenter_Panel,suggestedJobPanelGrp,selected_job_panel_grp");
        getLovBaseBean().setReturnMethodName("reviewMinListBean.jobForCrs");
        getLovBaseBean().setSearchMethod("reviewMinListBean.searchJob");
        getLovBaseBean().setSelectedDTOS(new ArrayList<IBasicDTO>());
        getLovBaseBean().setSelectedRadio("");
        getLovBaseBean().setSearchTyp("0");
        getLovBaseBean().setSearchQuery("");
        getLovBaseBean().setSearchMode(false);
        getLovBaseBean().setCancelSearchMethod("reviewMinListBean.cancelSearchLovDivForCrs");
    }
    ...
    public PagingResponseDTO searchWrkCentersWithPaging(PagingRequestDTO request) {
        ...
        IWorkCentersSearchCriteriaDTO srchDTO = 
            (IWorkCentersSearchCriteriaDTO)request.getSearchDTO();
...
//            jobList = new ArrayList();
    ...
    public List fillJobList() {
        setUsingPaging(true);
        if (getPageDTO() != null && 
            ((IEmpCandidatesDTO)getPageDTO()).getWorkCentersDTO() != null && 
            ((IEmpCandidatesDTO)getPageDTO()).getWorkCentersDTO().getCode() != 
            null) {
            try {
                jobList = 
        ...
        try {
            ...
            if ((searchQuery != null || !searchQuery.equals(""))) {
                    if(workCenterMode){
                        ...
                        if (getPageDTO() != null && 
                            ((IEmpCandidatesDTO)getPageDTO()).getWorkCentersDTO() != 
                            null && 
                            ((IEmpCandidatesDTO)getPageDTO()).getWorkCentersDTO().getCode() != 
                            null)
                            wrkCenterCode = 
    ...
    public PagingResponseDTO searchJobWithPaging(PagingRequestDTO request) {
        setSelectedRadio("");
        IJobSearchCriteriaDTO srchDTO = 
            (IJobSearchCriteriaDTO)request.getSearchDTO();
        try {
    ...
    public void showCaderListOfValuesDiv() {
        ...
        if (getLovBaseBean().isUsingPaging()) {
            getLovBaseBean().generatePagingRequestDTO("reviewMinListBean", 
                                                      "showCaderListOfValuesDivWithPaging");
        } else {
            try {
        ...
        getLovBaseBean().setReturnMethodName("reviewMinListBean.caderValue");
        getLovBaseBean().setSearchMethod("reviewMinListBean.searchCader");
        getLovBaseBean().setSelectedDTOS(new ArrayList<IBasicDTO>());
        getLovBaseBean().setSelectedRadio("");
        getLovBaseBean().setSearchTyp("0");
        getLovBaseBean().setSearchQuery("");
        getLovBaseBean().setSearchMode(false);
        getLovBaseBean().setCancelSearchMethod("reviewMinListBean.cancelSearchCaderLovDiv");
        getLovBaseBean().getMyDataTable().setFirst(0);
    }
    ...
    public void addRaiseToEmployee() {
        ISalElementGuidesDTO selectedSalElementGuidesDTO = 
            SalDTOFactory.createSalElementGuidesDTO();
        ISalElementGuidesDTO selectedEqSalElementGuidesDTO = 
            SalDTOFactory.createSalElementGuidesDTO();
        try {
    ...
    public List getCaderList() {
        if (caderList == null || 
            (caderList != null && caderList.size() == 0)) {
            try {
                caderList = 
    ...
    public List getGroupList() {
        if (suggestedCaderCode != null && !suggestedCaderCode.equals("")) {
            try {
                groupList = 
                        SalClientFactory.getSalElementGuidesClient().getLocalGroupCodeName(suggestedCaderCode);
    ...
    public List getRaiseList() {
        if (suggestedDegreeCode != null && !suggestedDegreeCode.equals("")) {
            try {
                raiseList =
                        SalClientFactory.getSalElementGuidesClient().getRaiseCodeName(suggestedDegreeCode);
    ...
    public List getDegreeList() {
        if (suggestedGroupCode != null && !suggestedGroupCode.equals("")) {
            try {
                degreeList =
                        (List)SalClientFactory.getSalElementGuidesClient().getDegreesTreeByGroupFirstLevel(suggestedGroupCode);
            } catch (SharedApplicationException e) {
                e.printStackTrace();
            } catch (Exception e) {
                e.printStackTrace();
    ...
    public List<IBasicDTO> getBudgetTypeList() {
        if ((budgetTypeList == null || budgetTypeList.size() == 0))
            try {
                budgetTypeList = 
                        BgtClientFactory.getBgtTypesClient().getCodeName();
            } catch (Exception e) {
                e.printStackTrace();
            }
...
//                workMinistriesList = 
//                        OrgClientFactory.getWorkCentersClient().getAllByMinistry(ministryEntityKey);
//            } catch (SharedApplicationException e) {
//                e.printStackTrace();
