...
<t:panelGrid columns="2" rowClasses="row02,row01" cellpadding="3"  cellspacing="0" width="100%">
 ...
 <t:inputText id="request_no" forceId="true" onkeypress="enabelFloatOnly(this);" onkeyup="enabelFloatOnly(this);" value="#{pageBeanName.searchDTO.admassignmentSerial}" styleClass="textboxmedium"/>
 <!-- Row4-->
