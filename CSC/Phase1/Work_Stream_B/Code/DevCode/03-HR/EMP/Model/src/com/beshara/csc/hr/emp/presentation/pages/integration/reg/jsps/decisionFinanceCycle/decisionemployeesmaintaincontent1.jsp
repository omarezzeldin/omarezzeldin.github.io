...
<t:panelGrid columns="6" rowClasses="row01,row02" width="100%" cellpadding="3" cellspacing="0" border="0" >
    ...
    <%--- Start of Row 2--%>
      ...
      <t:panelGroup colspan="5" rendered="#{pageBeanName.maintainMode == 0}">
        ...
        <t:panelGroup  onkeypress="FireButtonClickOldStyle(event,'addEmp');"  id="merDurationFromPnl" forceId="true" colspan="1">
            <t:inputCalendar  value="#{pageBeanName.pageDTO.decMerFromDate}" id="clndr_merDurationFromDate"
                ...
                styleClass="textbox" renderAsPopup="true" onchange="refreshOpBar();"
        ...
        <t:outputText forceId="true" id="merDurationTo" styleClass="divtext" value="#{regResources.merDurationTo}"/>
         <f:verbatim>&nbsp;&nbsp; </f:verbatim>
            ...
            <a4j:jsFunction name="refreshOpBar" reRender="OperationBar" />
        </t:panelGroup>
       ...
       <t:panelGroup colspan="1" >
            ...
            <t:inputText tabindex="4" onkeypress="FireButtonClickOldStyle(event,'addEmp');" forceId="true" id="fels_number1"  value="#{financeDecisionCycleEmployeesMaintainBean.felsValue}"  onkeyup="disableCharacters(this);" maxlength="3"  styleClass="textbox" style="width:30px;"   disabled="#{pageBeanName.showOnly}" />
            <f:verbatim>&nbsp; </f:verbatim>
            <t:inputText tabindex="3" onkeypress="FireButtonClickOldStyle(event,'addEmp');" forceId="true" id="denar_number1" value="#{financeDecisionCycleEmployeesMaintainBean.dinarValue}" onkeyup="disableCharacters(this);" maxlength="8"  styleClass="textbox"   style=" width: 50px;  margin-right: 4px; margin-left: 1px;"   disabled="#{pageBeanName.showOnly}" />
      ...
      <t:panelGroup colspan="5" id="totalValuePnl" forceId="true" >
        <t:inputText forceId="true" disabled="true" id="total_value"   styleClass="textbox"  converter="FloatNumberMaskConverter" value="#{detailBeanName.totalValueAsDobule}" />
      </t:panelGroup>
        <!-- ************************************************************************************************ -->
