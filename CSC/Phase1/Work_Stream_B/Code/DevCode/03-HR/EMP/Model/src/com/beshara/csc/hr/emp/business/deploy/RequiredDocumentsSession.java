 ...
 */
@Remote
public interface RequiredDocumentsSession extends BasicSession { // Add your extra methods
    ...
    public List<IInfDocumentTypesDTO> getAvailableDocuments(IRequestInfoDTO ri) throws RemoteException,
                                                                                                  DataBaseException,
                                                                                                  SharedApplicationException;
    /**
    ...
    public Long checkBeforeDeleteDocument(IRequestInfoDTO ri, Long docType, Long hireType) throws RemoteException,
                                                                                                  DataBaseException,
                                                                                                  SharedApplicationException;

    public List<IBasicDTO> getDocumentsByHireType(IRequestInfoDTO ri,
                                                             Long hireTypeCode) throws RemoteException,
                                                                                       DataBaseException,
                                                                                       SharedApplicationException;
}
