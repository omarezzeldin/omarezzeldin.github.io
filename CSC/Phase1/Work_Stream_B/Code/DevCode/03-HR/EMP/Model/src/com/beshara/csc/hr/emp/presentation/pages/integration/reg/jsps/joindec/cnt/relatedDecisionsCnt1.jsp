...
<t:panelGrid width="100%" columns="4" align="center" columnClasses="dataTableColumn1 padding5H,,dataTableColumn1," rowClasses="row01,row02" cellpadding="0" cellspacing="0">
    ...
    <t:inputText id="cnt1_code" value="#{jdHelperBeanName.displayedCode}" styleClass="textboxsmall" style="width:75px;" disabled="true" readonly="true"/>
    <t:outputText value="#{globalResources.name}"  styleClass="lable01"/>
    <t:inputText id="cnt1_name" value="#{jdHelperBeanName.displayedName}" styleClass="textboxXlargeOnly" disabled="true" readonly="true"/>
</t:panelGrid>
