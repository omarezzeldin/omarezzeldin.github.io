      ...
      <%--<h:outputText value="#{regResources.civil_id}" />--%>  
       ...
       <t:panelGroup colspan="3" id="civilPnl" forceId="true">
            <t:inputText  styleClass="textboxsmall2" value="#{detailBeanName.civilID}" maxlength="12" forceId="true" 
                          ...
                          disabled="#{pageBeanName.showOnly || financeDecisionCycleEmployeesMaintainBean.civilExist}"/>
               ...
               <f:verbatim>&nbsp;&nbsp; </f:verbatim>
                <a4j:commandButton type="button" value="#{globalResources.SearchButton}" styleClass="cssButtonSmallest"
                                ...
                                rendered="#{pageBeanName.decType!=2}"
                                   action="#{financeDecisionCycleEmployeesMaintainBean.showSearchForEmployeeDivBSN}" reRender="lovEmp"
                                  />   
                <a4j:commandButton type="button" value="#{globalResources.SearchButton}" styleClass="cssButtonSmallest"
                                   tabindex="3" disabled="#{pageBeanName.showOnly}" rendered="#{pageBeanName.decType==2}"
                                   oncomplete="changeVisibilityDiv(window.blocker,window.lovEmp);settingFoucsAtEmpLovDiv();"
                                   action="#{financeDecisionCycleEmployeesMaintainBean.showSearchForEmployeeDivForSearch1}" reRender="lovEmp"
                                  />   
                 ...
                 <t:commandButton id="searchemp" forceId="true" value="#{globalResources.Available}" styleClass="cssButtonSmall" disabled="#{pageBeanName.showOnly}" rendered="#{!financeDecisionCycleEmployeesMaintainBean.civilExist}"
                               onclick="resetErrorMsgs();return (validatemyForm('empValidCivil') );"
                                   action="#{financeDecisionCycleEmployeesMaintainBean.getEmployeeByCivilIDFromEmployees}"
                                   />
                <t:commandButton type="button" value="#{globalResources.reSetButton}" forceId="true" id="reSetData"
                                 rendered="#{financeDecisionCycleEmployeesMaintainBean.civilExist && !financeDecisionCycleMaintainBean.showOnly }"
                                 styleClass="cssButtonSmall" onclick="resetEmpDataFn();" />
                <a4j:jsFunction name="resetEmpDataFn" action="#{financeDecisionCycleEmployeesMaintainBean.resetEmpDataIfNoAddedElms}" 
            ...
            <h:outputText id="error_Message_1" forceId="true" styleClass="errMsg" value="#{regResources.missingCivilID}" rendered="#{ detailBeanName.showErrMsg }"/>
             <h:outputText id="no_mov_err" forceId="true" styleClass="errMsg" value="#{regResources.civil_is_not_currently_deligated}" rendered="#{!detailBeanName.hasMovingRequest}"/>
            ...
            <c2:regularExpressionValidator group="empValidCivil"  componentToValidate="civilIdInTxt" 
                ...
                highlight="false"  display="dynamic" active="#{financeDecisionCycleMainDataMaintainBean.divflag==false}"/>
       ...
       <t:outputText forceId="true" id="merDurationFrom" styleClass="divtext" value="#{regResources.merDurationFrom}"/>
        ...
        <t:panelGroup colspan="3" id="detail_sal_elm_guide" forceId="true"  rendered="#{!pageBeanName.showOnly}">
           <t:inputText id="dtl_sal_elm_guide_code"  styleClass="textboxsmall" forceId="true" value="#{detailBeanName.selectedElementGuideCode}"  disabled="#{pageBeanName.showOnly}" tabindex="4"
            ...
            <a4j:commandButton value="..." styleClass="cssButtonSmaller" disabled="#{pageBeanName.showOnly || !financeDecisionCycleEmployeesMaintainBean.civilExist}"
         ...
         <t:panelGroup colspan="2"  rendered="#{!pageBeanName.showOnly}">  
            ...
            <t:inputText tabindex="6" onkeypress="FireButtonClickOldStyle(event,'ava');" forceId="true" id="fels_number1"  value="#{financeDecisionCycleEmployeesMaintainBean.felsValue}"  onkeyup="disableCharacters(this);" maxlength="3"  styleClass="textbox" style="width:30px;"   disabled="#{pageBeanName.showOnly}" />
            <f:verbatim>&nbsp; </f:verbatim>
            <t:inputText tabindex="5" onkeypress="FireButtonClickOldStyle(event,'ava');" forceId="true" id="denar_number1" value="#{financeDecisionCycleEmployeesMaintainBean.dinarValue}" onkeyup="disableCharacters(this);" maxlength="8"  styleClass="textbox"   style=" width: 50px;  margin-right: 1px; margin-left: 1px;"   disabled="#{pageBeanName.showOnly}" />
                 <%--<h:commandButton id="ava" value="#{globalResources.Available}" styleClass="cssButtonSmall" style="padding:0;" action="#{decisionCycleEmployeesMaintainBean.findEmployeeByCivilIDFromEmployees}" onclick="return(validateRequiredElement('civilIdInTxt','#{resourcesBundle.missingCivilID}','errorCivilMessage') && checkExactLength('12','civilIdInTxt','errorCivilMessage','#{resourcesBundle.civilLengthError}') && isIntegerValueWithRequiredParam('civilIdInTxt','errorCivilMessage','#{globalResources.missingField}','#{resourcesBundle.num_int_msg}','true'));"  />--%>          
                 <%--<f:verbatim>&nbsp;&nbsp; </f:verbatim>--%>
                 <t:commandButton tabindex="7" id="ava" forceId="true" value="#{globalResources.addButton}" styleClass="cssButtonSmaller" disabled="#{pageBeanName.showOnly}"
                                   action="#{financeDecisionCycleEmployeesMaintainBean.addSalElmGuide}"  onclick="resetErrorMsgs();return (validatemyForm('empValidCivil') &&  validatemyForm('elmguideCode') && validatemyForm('elmguideData') );jumpToNextField('dtl_sal_elm_guide_code'); " 
                                   />
