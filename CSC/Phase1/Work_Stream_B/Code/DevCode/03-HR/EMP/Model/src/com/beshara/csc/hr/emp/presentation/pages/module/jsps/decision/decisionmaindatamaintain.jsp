...
<f:view locale="#{shared_util.locale}">
 ...
 <h:form enctype="multipart/form-data" id="myForm" binding="#{decisionMainDataMaintainBean.frm}">
    ...
    <t:aliasBean alias="#{detailBeanName}" value="#{hireDecisionMainData}">
...
<script type="text/javascript">
  ...
  initMCEEditor('maintain_decisionText');  
    ...
    /*  function validateDivorceDate(){
         
         
          var valid = validatemyForm('ValidateDate');
           var dateValid = validatemyForm('ValidateDate','aaa');
          alert(dateValid + ' fffffffff '+ valid);
          if( valid && dateValid){
          return true ;
          }else{
          return false ;
