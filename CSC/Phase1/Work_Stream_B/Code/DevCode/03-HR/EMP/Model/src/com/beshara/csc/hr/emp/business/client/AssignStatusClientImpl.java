...
import com.beshara.csc.hr.emp.business.deploy.AssignReasonsSession;
 ...
 * @since 03/09/2007
 */
public class AssignStatusClientImpl extends BaseClientImpl3 implements IAssignStatusClient {
    /**
     * @param AssignStatusSession
     */
    public AssignStatusClientImpl() {
        super();
    }
    ...
    protected Class<? extends BasicSession> getSessionInterface() {
        return AssignReasonsSession.class;
    }

    protected AssignReasonsSession SESSION() {
        return (AssignReasonsSession)super.SESSION();
    }
}
