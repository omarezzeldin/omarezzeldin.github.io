...
<t:panelGroup style="display:block;text-align: center;" forceId="true" id="btnPGId">
    <t:commandButton id="createInsurFile" forceId="true" value="#{integrationBundle2.create}"  onclick="block();"  
        disabled="#{pageBeanName.disabledButtons}"  styleClass="cssButtonSmall" action="#{pageBeanName.createBankFile}"/>
        <%--action="#{pageBeanName.createBankFile}"--%>
    <t:commandButton id="searchBtn" forceId="true" value="#{integrationBundle2.view}"  disabled="#{pageBeanName.disabledButtons}" 
        styleClass="cssButtonSmall"  action="#{pageBeanName.viewFileDetails}" />
        <%-- action="#{pageBeanName.viewFileDetails}"--%>
</t:panelGroup>
