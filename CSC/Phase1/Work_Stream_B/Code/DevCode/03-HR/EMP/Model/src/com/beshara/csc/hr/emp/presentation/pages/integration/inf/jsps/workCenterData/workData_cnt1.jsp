...
<style>
        .tree-area-tabs-With-1-row-filter {
...
<t:panelGroup forceId="true" style="width:100%" id="emp_query_panel_id">
    <t:panelGrid columnClasses="colu1,colu2" columns="4" width="100%" rowClasses="row01,row02" cellpadding="3"
        ...
        <h:outputText value="#{infIntegrationBundle.kwt_citizen_code}" styleClass="lable01"/>
        <t:panelGroup>
            <t:panelGroup>
                ...
                <h:outputText value="*" styleClass="mandatoryAsterisk" rendered="#{workDataListBeanName.showBtn}"/>
                <t:commandButton id="civil_exist_btn" forceId="true" onclick="return validatemyForm();"
                                 ...
                                 rendered="#{workDataListBeanName.showBtn}"/>
                <f:verbatim>
                    <br/>
                </f:verbatim>
        ...
        <t:outputText value="#{infIntegrationBundle.kwt_citizen_name}" styleClass="lable01"/>
        <t:panelGroup>
