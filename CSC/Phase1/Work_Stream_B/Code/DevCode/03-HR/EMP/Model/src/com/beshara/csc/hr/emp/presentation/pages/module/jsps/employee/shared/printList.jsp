                    ...
                    <t:panelGrid columns="4" cellspacing="0" cellpadding="5" border="0" rowClasses="row01,row02"
                            ...
                            <htm:table width="100%" border="0" cellspacing="0" cellpadding="3">
                                <htm:tr>
                                    ...
                                    <htm:td styleClass="group_title">
                                        <t:outputLabel value="#{resourcesBundle.candidate_main_data_label}"
                                                       styleClass="lable02"/>
                                    </htm:td>
                                </htm:tr>
                        ...
                        <t:panelGroup id="suggestedJobPanelGrp" forceId="true" colspan="3">
                            ...
                            <h:outputText value="#{resourcesBundle.orderType}"/>
                               <t:panelGroup colspan="3">
                            <t:inputTextarea disabled="true" tabindex="2" value="#{pageBeanName.pageDTO.hireStagesDTO.name}" cols="35" rows="1"
                        ...
                        <t:outputText value="#{resourcesBundle.choice_dept_notes_label}"/>
                        <t:panelGroup colspan="3">
                            <t:inputTextarea tabindex="7" disabled="true"
                                             value="#{pageBeanName.pageDTO.empExtraDataValueDTO.selectionDeptNotes}"
                                             cols="35" rows="4" styleClass="td_value" forceId="true"
                                             id="choice_dept_notes"/>
                        </t:panelGroup>
                        ...
                        <h:outputText value="#{resourcesBundle.bget_type_label}"/>
                        <t:panelGroup colspan="3">
                            <t:inputTextarea cols="35" rows="1" value="#{printListBean.bgtTypesDTO.name}"
                                             styleClass="td_value" disabled="true"/>
                        </t:panelGroup>
                        ...
                        <t:panelGroup colspan="3">
                            <t:inputTextarea disabled="true"
                                             ...
                                             tabindex="10" cols="35" rows="4" styleClass="td_value" forceId="true"
                        ...
                        <t:panelGroup colspan="4">
                            <htm:table width="100%" border="0" cellspacing="0" cellpadding="3">
                                <htm:tr>
                                    ...
                                    <htm:td styleClass="group_title">
                                        <t:outputLabel value="#{resourcesBundle.degree_data_arrow}"
                                                       styleClass="lable02"/>
                                    </htm:td>
                                </htm:tr>
                        ...
                        <t:inputText disabled="true" value="#{printListBean.acceptedRaiseName}" tabindex="11"
                                     styleClass="td_value"/>
                        <h:outputText value="#{resourcesBundle.jobs_opinion_notes_label}"/>
                        <t:panelGroup colspan="3">
