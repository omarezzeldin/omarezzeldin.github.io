                ...
                <htm:table border="0" width="99%" id="lovtable5" cellspacing="0" cellpadding="0">
                    ...
                    <htm:tr>
                        ...
                        <htm:td valign="top" bgcolor="#FFFFFF" styleClass="paddingbox" >
                           <t:panelGrid align="center" id="lov_searchPanel_radio" forceId="true" >
                           <t:panelGroup>
                            ...
                            <t:selectOneRadio tabindex="1" disabled="#{grsExceptionHelperBean.searchTransactions}" forceId="true" id="lov_searchRadioBtn" value="#{pageBeanName.lovBaseBean.searchTyp}" styleClass="divtext" onkeydown="onKeyDownFirstElement(event,'lov_searchText','lov_cancel')" >
    ...
    <t:panelGroup forceId="true" id="lov_dataT_data_panel" styleClass="lovDivScroll5">
       ...
       <t:column id="check_Second_column" styleClass="standardTable_Header3" width="5%" rendered="#{pageBeanName.lovBaseBean.multiSelect}">
        <f:facet name="header">
            ...
            <t:column  sortable="false"  width="20%" rendered="#{!grsExceptionHelperBean.searchTransactions}">
                <f:facet name="header">
              ...
              <t:column  sortable="false"  width="20%" rendered="#{grsExceptionHelperBean.searchConditions}">
                <f:facet name="header">
                 <t:commandLink id="sort_wrkLevelStatus" forceId="true" styleClass="headerLink" value="#{globalResources.status}" onclick="return false;">                         
                 </t:commandLink>
                </f:facet>
                
                <%--<t:outputText id="content_wrkLevelstatus" forceId="true" value="#{list.status}" />--%>
                   <t:graphicImage url="#{list.status == 1 ? '/app/media/images/DataGrid_Icon_green_flag.gif' : (list.status == pageBeanName.freezedFlag ? '/app/media/images/DataGrid_Icon_red_flag.gif' :(list.status == pageBeanName.pendingFlag ? '/app/media/images/DataGrid_Icon_yellow_flag.gif' : '/app/media/images/DataGrid_Icon_grey_flag.gif'))}"
                            onmouseover="doTooltip(event,'#{list.status == 1 ? grsIntgResources.Parameter_Status_Valid : grsIntgResources.Parameter_Status_InValid}')"
...
<t:panelGroup>
    <t:commandButton tabindex="5" forceId="true" id="lovDivOkTBtn" binding="#{pageBeanName.lovBaseBean.okBtnLovDiv}"
    disabled="true" value="#{globalResources.ok}" type="button" styleClass="cssButtonSmall" onclick="clearOutputText('errorMessag_lov'); return searchLovFunName();">
      <a4j:jsFunction name="searchLovFunName" action="#{pageBeanName.lovBaseBean.closeLovDiv}" 
      oncomplete="#{pageBeanName.lovBaseBean.onCompleteList};"
      reRender="#{pageBeanName.lovBaseBean.okCommandButton.reRender}"/>
    </t:commandButton>
...
<t:panelGroup>
    ...
    <a4j:support action="#{pageBeanName.resetLovDiv}" event="onclick"  oncomplete="hideLookUpDiv(window.blocker,window.divLov)"
    reRender="divSearch,lov_searchPanel,lov_searchPanel_radio,lov_dataT_data_panel"/>
</t:panelGroup>
...
<t:saveState value="#{pageBeanName.lovBaseBean.okCommandButton.reRender}"/>
