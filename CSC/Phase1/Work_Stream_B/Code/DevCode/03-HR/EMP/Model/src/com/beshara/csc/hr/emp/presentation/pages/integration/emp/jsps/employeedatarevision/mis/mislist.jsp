...
<f:view locale="#{shared_util.locale}">
    <f:loadBundle basename="com.beshara.csc.hr.emp.integration.presentation.resources.integration"
                  var="resourcesBundle"/>
    <h:form id="myForm" binding="#{govEmpMisBean.frm}">
        <t:aliasBean alias="#{pageBeanName}" value="#{govEmpMisBean}">
            <t:aliasBean alias="#{detailBeanName}" value="#{govEmpMisBean}">
                ...
                <t:saveState value="#{govEmpMisBean.misDataTableLst}"/>
                <t:saveState value="#{govEmpMisBean.vacDataTableLst}"/>
                <tiles:insert definition="misList.page" flush="false">
