...
<f:view locale="#{shared_util.locale}">
    ...
    <h:form id="myForm" binding="#{documentTypeMaintain.frm}">
        <t:aliasBean alias="#{pageBeanName}" value="#{hireTypesMaintainBean}">
            <t:aliasBean alias="#{detailBeanName}" value="#{documentTypeMaintain}">
                ...
                <tiles:insert definition="documentTypeMaintain.page" flush="false">
    ...
    <script type="text/javascript">
      ...
      adjustDataTable('dataT_data_panel','382');
