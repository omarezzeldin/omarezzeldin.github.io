...
import com.beshara.csc.hr.emp.presentation.backingbean.jobsArr.shared.config.BusinessService;
import com.beshara.csc.hr.emp.presentation.backingbean.jobsArr.shared.config.HireStageConst;
import com.beshara.csc.hr.emp.presentation.backingbean.jobsArr.shared.config.ReviewConfigBean;
...
public class ReviewListBean extends LookUpBaseBean {
    ...
    public static final String METHOD_NAME_ADD_SELECTED_CERTIFIED_JOBS = "jobsReviewListBean.jobForMinValue";
    ...
    private BusinessService biznasActions = new BusinessService();
    ...
    private static final String BEAN_NAME = "jobsReviewListBean";
    private static final String LIST_PAGE = "jobsReviewRequestPage";
    private static final String LIST_PAGE_APPROVE = "approveListPage";
    public ReviewListBean() {
        ...
        if (getLovBaseBean().isUsingPaging()) {
            getLovBaseBean().generatePagingRequestDTO("jobsReviewListBean", "initMainDataBean");
        } else {
    ...
    public void showJobDivCertified() {
        ...
        if (jobsDTO.getCode() != null) {
            excludedJobCodeList.add(jobsDTO.getCode().getKey());
        }
    ...
    public void findJobName() {
        ...
        try {
            ...
            setApprovedJobName(jobsDTO.getName());
    ...
    public void showViewByStage(Long stage) {
        ...
        case HireStageConst.HIRE_STAGE_JOB_NAME_REQUIRED:
            configBean.selectionjobArrangementView();
            break;

        case HireStageConst.HIRE_STAGE_FIN_DEGREE_REQUIRED:
            //fatwa-CRS ::matlob_t7ded-draga_malya
            if (isHasExperience()) {
    ...
    public void showListOfValuesDiv() {
        ...
        setJobMode(false);
        if (getLovBaseBean().isUsingPaging()) {
            getLovBaseBean().generatePagingRequestDTO("jobsReviewListBean", "showListOfValuesDivWithPaging");
        } else {
            try {
        ...
        getLovBaseBean().setReturnMethodName("jobsReviewListBean.wrkCenterValue");
        getLovBaseBean().setSearchMethod("jobsReviewListBean.searchWrkCenters");
        ...
        getLovBaseBean().setCancelSearchMethod("jobsReviewListBean.cancelSearchLovDiv");
    }
    ...
    public void showListOfValuesDivForJob() {
        ...
        getLovBaseBean().setUsingPaging(true);
        if (getLovBaseBean().isUsingPaging()) {
            getLovBaseBean().generatePagingRequestDTO("jobsReviewListBean", "getJobListForMinWithPaging");

        }

        getLovBaseBean().getOkCommandButton().setReRender("WorkCenter_Panel,suggestedJobPanelGrp,selected_job_panel_grp");
        getLovBaseBean().setReturnMethodName("jobsReviewListBean.jobForMinValue");
        getLovBaseBean().setSearchMethod("jobsReviewListBean.searchJob");
        getLovBaseBean().setSelectedDTOS(new ArrayList<IBasicDTO>());
        getLovBaseBean().setSelectedRadio("");
        getLovBaseBean().setSearchTyp("0");
        getLovBaseBean().setSearchQuery("");
        getLovBaseBean().setSearchMode(false);
        getLovBaseBean().setCancelSearchMethod("jobsReviewListBean.cancelSearchLovDivForJob");
    }
    ...
    public void showListOfValuesDivForJobCrs() {
        ...
        getLovBaseBean().getOkCommandButton().setReRender("WorkCenter_Panel,suggestedJobPanelGrp,selected_job_panel_grp");
        getLovBaseBean().setReturnMethodName("jobsReviewListBean.jobForCrs");
        getLovBaseBean().setSearchMethod("jobsReviewListBean.searchJob");
        getLovBaseBean().setSelectedDTOS(new ArrayList<IBasicDTO>());
        getLovBaseBean().setSelectedRadio("");
        getLovBaseBean().setSearchTyp("0");
        ...
        if (searchQuery != null && !searchQuery.toString().equals("") && searchType != null &&
            ...
            if (searchQuery != null && !searchQuery.equals("")) {
                ...
                if (getLovBaseBean().isUsingPaging()) {
                    ...
                    getLovBaseBean().generatePagingRequestDTO("jobsReviewListBean", "searchWrkCentersWithPaging",
                                                              srchDTO);
    ...
    public void jobForMinValue() {
        ...
        if (jobFilter != null && jobFilter.getSelectedDTOS() != null && !jobFilter.getSelectedDTOS().isEmpty()) {
            try {
                ...
                setApprovedJobName(jobFilter.getSelectedDTOS().get(0).getName());
                setJobKey(((IJobsDTO)jobFilter.getSelectedDTOS().get(0)).getJobKey());
                setJobsDTO((IJobsDTO)jobFilter.getSelectedDTOS().get(0));
    ...
    public void initTreeDivBean() {
        ...
        treedivBean.setCancelSearchMethod("jobsReviewListBean.cancelTreeSearch");
        ValueBinding vb =
    ...
    public void showCaderListOfValuesDiv() {
        ...
        setRenderLovDiv(true);
        if (getLovBaseBean().isUsingPaging()) {
            getLovBaseBean().generatePagingRequestDTO("jobsReviewListBean", "showCaderListOfValuesDivWithPaging");
        } else {
            try {
        ...
        getLovBaseBean().setReturnMethodName("jobsReviewListBean.caderValue");
        getLovBaseBean().setSearchMethod("jobsReviewListBean.searchCader");
        getLovBaseBean().setSelectedDTOS(new ArrayList<IBasicDTO>());
        getLovBaseBean().setSelectedRadio("");
        getLovBaseBean().setSearchTyp("0");
        getLovBaseBean().setSearchQuery("");
        getLovBaseBean().setSearchMode(false);
        getLovBaseBean().setCancelSearchMethod("jobsReviewListBean.cancelSearchCaderLovDiv");
        getLovBaseBean().getMyDataTable().setFirst(0);
    }
    ...
    public void OpenTreeDiv() {
        ...
        try {
            ...
            treedivBean.setClientValueBinding("jobsReviewListBean.salElementClient");
        ...
        MethodBinding mb =
            FacesContext.getCurrentInstance().getApplication().createMethodBinding("#{jobsReviewListBean.addSelectedRaise}",
                                                                                   null);
    ...
    public void searchCader(Object searchType, Object searchQuery) {
        if (searchQuery != null && !searchQuery.toString().equals("") && searchType != null &&
            ...
            if (getLovBaseBean().isUsingPaging()) {
                ...
                getLovBaseBean().generatePagingRequestDTO("jobsReviewListBean", "searchCaderWithPaging");
    ...
    private Long getMinistryCode() {
        if (getPageDTO() != null && getPageDTO() instanceof IEmpCandidatesDTO) {
    ...
    public void setBiznasActions(BusinessService biznasActions) {
        this.biznasActions = biznasActions;
    }

    public BusinessService getBiznasActions() {
    ...
    public String viewDocumentsApprove() {
        if (this.getPageDTO() != null ) {
            ...
            viewDocuments.setBckBtnNavigationCase("approveListPage");
        }
    ...
    public String viewDocuments() {
        if (this.getPageDTO() != null ) {
            ...
            viewDocuments.setPageDTO(empCandidatesDTO);
            viewDocuments.setBackActionMethodName("");
            viewDocuments.setBckBtnNavigationCase("jobsReviewRequestPage");
        }
        return "viewDocumentsPage";
    }
...
//        setApprovedJobName(".");
//    } else {
//        if (getApprovedJobName()== null || getApprovedJobName().trim().equals("")) {
//            setApprovedJobName("");
//        }
//    }
