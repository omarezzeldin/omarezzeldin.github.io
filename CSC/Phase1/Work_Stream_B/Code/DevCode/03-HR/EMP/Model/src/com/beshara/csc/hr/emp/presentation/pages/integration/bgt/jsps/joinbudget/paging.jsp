...
<t:panelGroup forceId="true" id="paging_panel" rendered="#{pageBeanName.pageMode != 1}">
    <t:panelGroup forceId="true" id="paging_panel_group" rendered="#{ (OperationBar.recordsCount > 0) ? true : false }">
       ...
       <h:panelGrid id="panelGrd_scroller" columns="1" dir="#{shared_util.pageDirection}" styleClass="scroller"  rendered="#{pageBeanName.listSize > shared_util.noOfTableRows}" >
