...
<f:view locale="#{shared_util.locale}">
    ...
    <h:form id="myForm" binding="#{govEmpSeventhStepBean.frm}">
        ...
        <t:aliasBean alias="#{detailBeanName}" value="#{govEmpMaintainBean}">
            ...
            <tiles:insert flush="false" definition="govempseventhstep.page">
