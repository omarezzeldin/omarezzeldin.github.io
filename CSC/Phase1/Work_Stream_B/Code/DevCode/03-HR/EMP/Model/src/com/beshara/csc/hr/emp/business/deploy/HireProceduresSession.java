 ...
 */
@Remote
public interface HireProceduresSession extends BasicSession { // Add your extra methods

    public List remove(IRequestInfoDTO ri, List<IBasicDTO> hireProceduresDTOlist) throws RemoteException,
    ...
    public List<IBasicDTO> getAllRelatedByHireProcdure(IRequestInfoDTO ri,
                                                       Long hireProcdureCode) throws RemoteException,
                                                                                     DataBaseException,
                                                                                     SharedApplicationException;

    public boolean duplicatedHireProcdureName(IRequestInfoDTO ri,String name,Long hireProcdureCode) throws RemoteException,
                                                                                        DataBaseException, 
                                                                                        SharedApplicationException;
