package com.beshara.csc.hr.emp.presentation.backingbean.employmentrequestenquiry;
...
public class EmployeeListOfValues extends LOVBaseBean {
    ...
    private IEmpReqEnquiryDTO empEmployeeSearchDTO ;
    ...
    public String cancelSearchLovDiv() {
        ...
        empEmployeeSearchDTO.setRealCivilId(null);
    ...
    public void searchForEmployee(Object searchType, Object searchQuery) {
        ...
        if (searchQuery != null && !searchQuery.toString().equals("") && searchType != null &&
            ...
            if (searchType.toString().equals("0")){
                empEmployeeSearchDTO.setRealCivilId(Long.valueOf(searchQuery.toString()));
                empEmployeeSearchDTO.setName(null);
    ...
    private com.beshara.base.paging.impl.PagingResponseDTO getSearchByEmpWithPaging(PagingRequestDTO pagingRequestDTO) {
        ...
        try {
            ...
            bsnPagingResponseDTO =
                    (com.beshara.base.paging.impl.PagingResponseDTO)EmpClientFactory.getEmpCandidatesClient().getAllCandidateDataWithPaging(empEmployeeSearchDTO);
    ...
    public void setEmpEmployeeSearchDTO(IEmpReqEnquiryDTO  empEmployeeSearchDTO) {
        this.empEmployeeSearchDTO = empEmployeeSearchDTO;
    }

    public IEmpReqEnquiryDTO  getEmpEmployeeSearchDTO() {
