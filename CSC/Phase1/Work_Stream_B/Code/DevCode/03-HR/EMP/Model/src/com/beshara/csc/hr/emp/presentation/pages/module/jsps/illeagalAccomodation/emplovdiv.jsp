...
<t:panelGroup forceId="true" id="civil_div_paging_panel">
        <h:panelGrid id="civil_div_panelGrd_scroller" columns="1" dir="#{shared_util.pageDirection}" styleClass="scroller" width="300px" rendered="#{detailBeanName.empListOfValues.listSize > shared_util.noOfTableRows}" >
          ...
          <t:dataScroller id="civil_div_scroll_1" 
                    ...
                    actionListener="#{detailBeanName.openLovDiv}">
                <f:facet name="first" >                            
...
<t:panelGrid columns="2" align="center">
 <a4j:commandButton id="civil_div_ok" value="#{globalResources.ok}" action="#{detailBeanName.empListOfValues.closeLovDiv}" styleClass="cssButtonSmall" oncomplete="hideLookUpDiv(window.blocker,window.customDiv1);showToggle();" reRender="#{detailBeanName.empListOfValues.renderedDropDown}" binding="#{detailBeanName.empListOfValues.okCommandButton}" disabled="#{empty detailBeanName.empListOfValues.selectedDTOS && empty detailBeanName.nonCheckList}" />
...
<t:panelGroup>
    ...
    <a4j:support action="#{detailBeanName.hideEmpLovDiv}" event="onclick"  oncomplete="hideLookUpDiv(window.blocker,window.customDiv1);if(typeof(setFocusAfterCloseEmpLovDiv)!='undefined'){setFocusAfterCloseEmpLovDiv()};" reRender="divSearch"/>
</t:panelGroup>
...
<t:saveState value="#{detailBeanName.empListOfValues.selectedRadio}"/>
