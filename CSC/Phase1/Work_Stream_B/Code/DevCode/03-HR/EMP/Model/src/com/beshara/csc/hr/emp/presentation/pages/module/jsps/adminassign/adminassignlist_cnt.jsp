...
<t:dataTable id="dataT_data" var="list" value="#{pageBeanName.usingPaging ? pageBeanName.pagingBean.myPagedDataModel : pageBeanName.myTableData}" rowStyleClass="#{ pageBeanName.selected ? 'standardTable_RowHighlighted' : null}" forceIdIndexFormula="#{list.code.key}"
  ...
  <t:column id="check_column"  width="5%">  
       <f:facet name="header"/>
       <t:selectOneRadio  id="chk" value="#{pageBeanName.selectedRadio}" onmousedown="toggleRadio(this);" onkeyup="toggleRadioKeyUp(this);" styleClass="radioButton_DataTable">
  ...
  <t:column id="civilid_column" width="10%">
    <f:facet name="header">      
 ...
 <t:column id="request_no_column" width="8%">
    <f:facet name="header">
  ...
  <t:column id="assignment_from_date_column" width="12%">
    <f:facet name="header">
  ...
  <t:column id="assignment_to_date_column" width="12%">
    <f:facet name="header">
  ...
  <t:column id="assignment_reason_column" width="28%">
    <f:facet name="header">
