...
import com.beshara.csc.hr.emp.business.deploy.HireStatusSession;
 ...
 * @since 03/09/2007
 */
public class HireStatusClientImpl extends BaseClientImpl3 implements IHireStatusClient {

    public HireStatusClientImpl() {
        super();
    }
    ...
    protected Class<? extends BasicSession> getSessionInterface() {
        return HireStatusSession.class;
    }

    @Override
    protected HireStatusSession SESSION() {
        return (HireStatusSession)super.SESSION();
    }
