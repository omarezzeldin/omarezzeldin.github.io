...
<f:view locale="#{shared_util.locale}">
    ...
    <h:form id="myForm" binding="#{adminAssignListBean.frm}">
       <t:aliasBean alias="#{pageBeanName}" value="#{adminAssignListBean}">
      ...
      <tiles:insert definition="adminassignlist.page" flush="false">
      </tiles:insert>
