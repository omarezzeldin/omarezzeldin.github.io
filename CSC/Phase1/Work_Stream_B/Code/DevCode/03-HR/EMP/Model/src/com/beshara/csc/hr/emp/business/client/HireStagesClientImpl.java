...
import com.beshara.csc.hr.emp.business.deploy.HireStagesSession;
 ...
 * @since 03/09/2007
 */
public class HireStagesClientImpl extends BaseClientImpl3 implements IHireStagesClient {

    public HireStagesClientImpl() {
    }
    @Override
    protected Class<? extends BasicSession> getSessionInterface() {
        return HireStagesSession.class;
    }
    
    protected HireStagesSession SESSION(){
        return (HireStagesSession)super.SESSION();
    }
    /** 
     * @return List 
     */
