...
<t:panelGroup forceId="true" id="empLovDivContainer">
                        ...
                        <htm:td valign="top" bgcolor="#FFFFFF" styleClass="paddingbox">
                           <t:panelGrid align="center">  
                            ...
                            <t:panelGrid align="center" columns="4" border="0" width="50%" forceId="true" id="civil_div_searchPanel">
                             <t:inputText onkeypress="FireButtonClick('myForm:civil_div_search');" forceId="true" id="civil_div_searchText"  value="#{pageBeanName.empListOfValues.searchQuery}" styleClass="textboxmedium" maxlength="12"/>
                             <t:panelGroup>
                             ...
                             <a4j:jsFunction name="searchEmpListOfVal"  action="#{pageBeanName.empListOfValues.searchLovDiv}" 
                                            reRender="civil_div_dataT_data_panel,civil_div_searchPanel,errorMessage,civil_div_paging_panel,civil_div_paging_panel,civil_div_ok,empLovDivContainer"
                                            oncomplete="setFocusOnlyOnElement('civil_div_searchText');"/>
                             
                             </t:panelGroup>
                             <f:verbatim>&nbsp;&nbsp;</f:verbatim>
                             <a4j:commandButton id="civil_div_cancelSearch" action="#{pageBeanName.empListOfValues.cancelSearchLovDiv}" reRender="civil_div_ok,civil_div_searchText,civil_div_dataT_data_panel,civil_div_searchPanel,errorMessage,civil_div_paging_panel,civil_div_searchRadioBtn,civil_div_ok,empLovDivContainer"  styleClass="ManyToManyCancelSearchButton" rendered="#{pageBeanName.empListOfValues.searchMode}" />
...
<t:panelGrid border="0" cellpadding="0" cellspacing="0" width="100%">
    ...
    <t:panelGroup forceId="true" id="civil_div_dataT_data_panel" styleClass="lovDivScroll5">
        ...
        <t:dataTable id="civil_div_dataT_data" var="list" value="#{pageBeanName.empListOfValues.usingPaging ? employeeHistory.empListOfValues.pagingBean.myPagedDataModel : employeeHistory.empListOfValues.myTableData}" rowStyleClass="#{ pageBeanName.empListOfValues.selected ? 'standardTable_RowHighlighted' : null}"
        ...
        <t:selectOneRadio styleClass="radioButton_DataTable" id="chk" 
         ...
         <a4j:support event="onclick" actionListener="#{pageBeanName.empListOfValues.selectedRadioButton}" reRender="civil_div_ok"/>
            ...
            <t:column  sortable="false"  width="20%">
                <f:facet name="header">
                 <t:outputLabel id="sort_code" forceId="true" styleClass="headerLink" value="#{globalResources.globalCivilId}" onclick="return false;"/>
                </f:facet>
            ...
            <t:column  sortable="false" width="75%">
                <f:facet name="header">
                 <t:outputLabel id="sort_name" forceId="true" styleClass="headerLink" value="#{globalResources.globalName}" onclick="return false;"/>
                </f:facet>
...
<t:panelGrid columns="2" align="center">
 <a4j:commandButton id="civil_div_ok" value="#{globalResources.ok}" action="#{pageBeanName.empListOfValues.closeLovDiv}" styleClass="cssButtonSmall" oncomplete="hideLookUpDiv(window.blocker,window.lovEmp)" reRender="#{pageBeanName.empListOfValues.renderedDropDown}" binding="#{pageBeanName.empListOfValues.okCommandButton}" disabled="#{empty pageBeanName.empListOfValues.selectedDTOS}" />
 <t:commandButton onblur="settingFoucsAtEmpLovDiv();" forceId="true" id="backButtonEmpLovDiv" type="button" value="#{globalResources.back}" onclick="hideLookUpDiv(window.blocker,window.lovEmp);" styleClass="cssButtonSmall"/>
</t:panelGrid>
</t:panelGroup>
