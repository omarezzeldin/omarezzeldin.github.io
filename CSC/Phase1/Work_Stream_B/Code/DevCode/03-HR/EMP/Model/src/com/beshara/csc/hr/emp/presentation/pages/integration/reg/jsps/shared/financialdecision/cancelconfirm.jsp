...
<t:panelGrid columns="1" width="100%" align="center">
     <t:panelGroup forceId="true" id="divcustomDiv3"  style="width:600px;" >
           <t:panelGrid columns="2" align="center">
              <t:outputText value="#{regResources.cancelDecision_confirm }" styleClass="msg" />
           </t:panelGrid>
    </t:panelGroup>
    <t:panelGrid columns="2" align="center">
        <%-- updated by Ashraf Gaber 24/2/09 to handel keyboard shortcuts --%>
        <t:commandButton forceId="true" id="OkButtondivcustomDiv3" onblur="if(isVisibleComponent('customDiv3'))document.getElementById('CancelButtondivcustomDiv3').focus();" styleClass="cssButtonSmall" value="#{globalResources.ok}" action="#{pageBeanName.cancelDecision}" />
        ...
        <t:commandButton forceId="true" id="backButtonCustomDiv3" type="button" styleClass="cssButtonSmall" value="#{globalResources.back}"  onclick="hideLookUpDiv(window.blocker,window.customDiv3,'','','');"/>
    </t:panelGrid>
</t:panelGrid>