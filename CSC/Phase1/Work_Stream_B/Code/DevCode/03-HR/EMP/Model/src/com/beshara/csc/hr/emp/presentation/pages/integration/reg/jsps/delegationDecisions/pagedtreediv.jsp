...
<t:panelGroup forceId="true" id="pagedTreeDiv">
    ...
    <h:outputText    forceId="true" id="error1" value="#{resourcesBundle.MessageForWrongElmguide}" styleClass="errMsg" rendered="#{!delegationDecisionElmsBean.validElmguide}" />
    </t:panelGrid>
            ...
            <t:panelGrid columns="2" align="center">
                ...
                <t:panelGroup forceId="true" id="okPanel">
                    <a4j:commandButton id="okBtn"  value="#{globalResources.ok}"  binding="#{treeDivBean.okCommandButton}"
                        styleClass="cssButtonSmall" action="#{delegationDecisionElmsBean.vaildateElmguide}"
                        oncomplete="checkValidElmguide()" reRender="btnPnl,validElmguide,errPanel,errorcodeMsg,errorMsg,dtl_sal_elm_guide_code,dtl_sal_elm_guide,detail_sal_elm_guide,scriptPanel,scriptGenerator,OperationBar,paging_panel"/>                       
                </t:panelGroup>
    ...
    <t:inputHidden forceId="true" id="scrollY" value="#{treeDivBean.scrollY}"/>
     <t:inputHidden forceId="true" id="validElmguide" value="#{delegationDecisionElmsBean.validElmguide}"/>
</t:panelGroup>
