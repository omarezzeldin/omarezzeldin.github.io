...
<t:panelGroup>
        ...
        <t:panelGrid columns="4" id="proceedCandidateContinerEmp" rowClasses="row02,row01" width="100%" border="0" cellpadding="3" cellspacing="0"
            ...
            <t:selectOneMenu id="candTypesList1" tabindex="1" onkeydown="onKeyDownFirstElement(event,'categoryId','ministryListID')" forceId="true" styleClass="DropdownboxxLarge2" style="width: 336px;"
                ...
                <a4j:support event="onchange" reRender="paging_panel_group,listSize,divMsg,dataT_data_panel, OperationBar, paging_panel,errorCodePanelId,errorCodePanelId2,categoryId,categoryList,ministryListID,ministryId"
            ...
            <t:selectOneMenu id="candTypesList2"  forceId="true" styleClass="DropdownboxxLarge2" style="width: 336px;"
                ...
                <a4j:support event="onchange" 
                             reRender="divMsg,OperationBar,ministryListID,ministryId,listSize,dataT_data_panel,paging_panel_group,errorCodePanelId,errorCodePanelId2,paging_panel"  action="#{pageBeanName.fillDataTableByStageId}" oncomplete="changeVisibilityMsg()"/>
            </t:selectOneMenu>
            ...
            <h:outputText id="ministry_name" value="#{resourcesBundle.emp_internal_exp_minName}" styleClass="lable01"/>
             ...
             <%--<a4j:jsFunction name="changeMinistryVal" actionListener="#{pageBeanName.filterByMinistry}" oncomplete="copyDropdownIntoInputtext('ministry', 'ministryId');" reRender="OperationBar,listSize,dataT_data_panel,paging_panel_group"/>--%>
                 <a4j:jsFunction name="changeMinistryVal" actionListener="#{pageBeanName.filterByMinistry}" oncomplete="copyDropdownIntoInputtext('ministryId', 'ministryId');" reRender="OperationBar,listSize,dataT_data_panel,paging_panel,paging_panel_group,errorCodePanelId2"/>
