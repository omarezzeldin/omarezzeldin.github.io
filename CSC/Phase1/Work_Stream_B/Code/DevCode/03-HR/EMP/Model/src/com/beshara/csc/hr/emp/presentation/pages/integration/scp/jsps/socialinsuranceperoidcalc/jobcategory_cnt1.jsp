...
<a4j:jsFunction action="#{socialInsurPeroidCalcJobCategoryBean.showHideFilterPnl}" name="showHideFilterPnlFn"
                ...
                oncomplete="togglePageUsingCstmHeight('hideQulDivImg', 'mainPnl', 'dataT_data_panel',115,408,document.getElementById('filterPnlCollapsed').value);"/>
...
<jsp:include page="/integration/scp/jsps/socialinsuranceperoidcalc/maindata_cnt1.jsp"/>
 ...
 <t:panelGroup id="hiddenBtnPnl" forceId="true">
        <t:inputHidden id="filterPnlCollapsed" forceId="true" value="#{socialInsurPeroidCalcJobCategoryBean.filterPnlCollapsed}"/>
    </t:panelGroup>   
<htm:script>
function checkCollapsed() {
      togglePageUsingCstmHeight('hideQulDivImg', 'mainPnl', 'dataT_data_panel', 115, 408, document.getElementById('filterPnlCollapsed').value);
  }
  checkCollapsed();
